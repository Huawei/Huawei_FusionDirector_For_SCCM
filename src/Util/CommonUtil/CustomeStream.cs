...
{
    public class CustomeStream : Stream       /* http://msdn.microsoft.com/en-us/library/system.io.stream.aspx */
    {
        #region Constructors

        public CustomeStream()
        {
            Position = 0;
        }

        public CustomeStream(byte[] source)
        {
        ...
        public CustomeStream(int length)
        {
            SetLength(length);
            Position = length;
