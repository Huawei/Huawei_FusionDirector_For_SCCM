    ...
    public class HttpWhiteListHepler
    {
        ...
        public HttpWhiteListHepler()
        {
            this.WhiteList = new List<UrlInfo>()
            {
                ...
                new UrlInfo(){ Url="/rich/UpgradeService/UpdatableDevices",HttpMethod="GET"},
                ...
                new UrlInfo(){ Url="/rich/UpgradeService/ProductType",HttpMethod="GET"},
                new UrlInfo(){ Url="/rich/UpgradeService/Devices",HttpMethod="GET"},
                new UrlInfo(){ Url="/rich/UpgradeService/Network",HttpMethod="GET"},
                ...
                new UrlInfo(){ Url="/rich/UpgradeService/Actions/UpgradeService.UpgradeableEnclosureInfo",HttpMethod="POST"},
                new UrlInfo(){ Url="/rich/UpgradeService/Actions/UpgradeService.DeviceFirmwareInfo",HttpMethod="POST"},
                new UrlInfo(){ Url="/rich/ServerProfiles/Actions/ServerProfile.Binding",HttpMethod="POST"},
                new UrlInfo(){ Url="/rich/ServerProfiles/Actions/ServerProfile.Unbinding",HttpMethod="POST"},
