  ...
  var upgradePackageManage = {
      ...
      getAllBaselineList: function (param, callback) {
          ...
          endpoint += "?$orderby=" + param.orderby;
       ...
       * 获取设备列表
       */
      getDevices: function (param, callback) {
          var endpoint = '/rich/UpgradeService/UpdatableDevices';
       ...
       * 获取组设备列表
       */
      getGroupDevices: function (param, callback) {
      ...
      checkDeviceFirmware: function (param, callback) {
          var endpoint = '/rich/UpgradeService/Actions/UpgradeService.DeviceFirmwareInfos';
          var data = {
              "ips": [param.ip],
              "httpMethod": 'POST',
              "endpoint": endpoint,
