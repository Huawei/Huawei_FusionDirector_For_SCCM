var errorCode_zh_CN = {
    ...
    "-50002": "请先在FusionDirector Web界面添加FD",
    ...
    'Base.1.0.EventSubscriptionLimitExceeded': 'The event subscription failed due to the number of simultane===ous subscriptions exceeding the limit of the implementation.',
    ...
    "FusionDirector.1.0.EventSenderMailAddrErr": {
        "Message": "SMTP服务器IP地址或端口错误。",
        "NumberOfArgs": 0,
        "Resolution": "请排查SMTP服务器IP地址和端口是否正确，并在修改后重新配置。"
    },
    ...
    "FusionDirector.1.0.AppconfigInvalidIpv4DNSServer": {
        "Message": "无效的IPv4 DNS服务器。",
        "NumberOfArgs": 0,
        "Resolution": "请修改IPv4 DNS服务器后重试。"
    },
    "FusionDirector.1.0.AppConfigInvalidIpv6DNSServer": {
    ...
    "FusionDirector.1.0.AppConfigDNSServerAuthenticationErr": {
        "Message": "DNS服务器认证错误。",
        "NumberOfArgs": 0,
        "Resolution": "请确保DNS服务器支持外部配置操作，并检查DNS认证信息后重试。"
    },
    "FusionDirector.1.0.AppConfigDNSServerKeyErr": {
        "Message": "DNS服务器key值错误。",
        "NumberOfArgs": 0,
        "Resolution": "请提供有效DNS key值后重试。"
    },
    "FusionDirector.1.0.AppConfigPartSuccess": {
        "Message": "部分操作失败。",
        "NumberOfArgs": 0,
        "Resolution": "请确保两个DNS服务器均有效后重试。"
    },
    "FusionDirector.1.0.AppConfigDeleteDNSServerFailed": {
        "Message": "删除DNS服务器失败。",
        "NumberOfArgs": 0,
        "Resolution": "请确保DNS服务器有效后重试。"
    },
    ...
    "FusionDirector.1.0.ClusterNetworkDomainsMismatch": {
        "Message": "待添加节点的网络平面与集群网络平面不匹配。",
        "NumberOfArgs": 0,
        "Resolution": "请单击右上角\"帮助\"，参考联机帮助的内容，将待添加节点或集群节点恢复出厂设置，重新配置部署，确认待添加节点网络平面与集群网络平面匹配后，重新添加节点。"
    },
    ...
    "FusionDirector.1.0.UpgradeAlreadyHasPlan": {
        "Message": "设备%1已经被启用的计划%2绑定。",
        "NumberOfArgs": 2,
        "Resolution": "请等待原计划执行结束或者先停用原计划。"
    },
    ...
    "FusionDirector.1.0.SwitchProfileError17": {
        "Message": "该网络不支持设置为Untaged vlan",
        "NumberOfArgs": 0,
        "Resolution": "请勿将该网络设置为Untaged vlan"
    },
    "FusionDirector.1.0.SwitchProfileError18": {
        "Message": "一个端口只允许设置一个Untaged vlan",
        "NumberOfArgs": 0,
        "Resolution": "请勿在一个端口上设置多个Untaged vlan"
    },
    ...
    "FusionDirector.1.0.SwitchProfileError22": {
        "Message": "上、下行口FCoE vlan ID不能相同",
        "NumberOfArgs": 0,
        "Resolution": "请确保上、下行口FCoE vlan ID不相同"
    },
    ...
    "FusionDirector.1.0.SwitchProfileError75": {
        "Message": "连接到同一个内部链路聚合组的服务器网口，必须使用相同的Untaged VLAN ID",
        "NumberOfArgs": 0,
        "Resolution": "请确保Untaged VLAN ID相同"
    },
    ...
    "FusionDirector.1.0.SwitchProfileError81": {
        "Message": "连到同一个内部EthTrunk的网络不允许同时设置成Untaged VLAN和Taged VLAN",
        "NumberOfArgs": 0,
        "Resolution": "请勿将同一个网络同时设置成Untaged VLAN和Taged VLAN"
    },
    ...
    "FusionDirector.1.0.IAMTestLDAPControllerFailed": {
        "Message": "域控制器%1测试连通性失败",
        "NumberOfArgs": 1,
        "Resolution": "请确保域控制器信息配置正确，然后重试。"
    },
    "FusionDirector.1.0.IAMAuthenticationFailure": {
        "Message": "域控制器%1用户名或密码错误",
        "NumberOfArgs": 1,
        "Resolution": "请提供有效凭证后重试。"
    },
    "FusionDirector.1.0.DevMgmtServerNotExist": {
        "Message": "所操作的服务器不存在",
        "NumberOfArgs": 0,
        "Resolution": "请确认服务器状态"
    },
    "FusionDirector.1.0.DevMgmtTaskNotExist": {
        "Message": "所操作的任务不存在",
        "NumberOfArgs": 0,
        "Resolution": "请刷新任务后重试"
    },
    "FusionDirector.1.0.DevMgmtPartSuccess": {
        "Message": "部分操作成功",
        "NumberOfArgs": 0,
        "Resolution": "请重试。如果错误仍然存在，联系支持"
    },
    "FusionDirector.1.0.QueryParameterExcessLimit": {
        "Message": "查询参数%1个数超过%2。",
        "NumberOfArgs": 2,
        "Resolution": "请减少参数个数，然后重试。"
    },
    "FusionDirector.1.0.ClusterVerifyHostFailed": {
        "Message": "无法验证远程备份配置。",
        "NumberOfArgs": 0,
        "Resolution": "确保用户名和密码设置正确无误，并且用户对远程备份位置的文件夹有写入访问权限。"
    },
    "FusionDirector.1.0.ClusterGetKeyInfoFailed": {
        "Message": "无法取得SSH信息：无法为远程服务器生成公钥。",
        "NumberOfArgs": 0,
        "Resolution": "输入有效的远程主机名或IP，然后重试该操作。"
    },
    "FusionDirector.1.0.AppConfigDNSServerCheckErr": {
        "Message": "域名或DNS服务器异常。",
        "NumberOfArgs": 0,
        "Resolution": "请检查域名信息或DNS服务器后重试。"
    },
    "FusionDirector.1.0.ModifyiBMCAccountNotSupportedOnState": {
        "Message": "设备 %1 当前的状态不支持修改iBMC密码",
        "NumberOfArgs": 1,
        "Resolution": "请等待设备处于合适的状态后再尝试此操作。"
    },
    "FusionDirector.1.0.BMCAuthenticationFailure": {
        "Message": "访问bmc认证失败",
        "NumberOfArgs": 0,
        "Resolution": "请输入有效的认证后重试"
    },
    "FusionDirector.1.0.DeployServiceNullPartitionFilesystem": {
        "Message": "自定义分区文件系统不匹配",
        "NumberOfArgs": 0,
        "Resolution": "请重新选择分区文件系统，然后重试"
    },
    "FusionDirector.1.0.DeployServiceNullSurpportPartition": {
        "Message": "此类型的子类型暂不支持自定义分区",
        "NumberOfArgs": 0,
        "Resolution": "请选择自动分区模式，然后重试"
    },
    "FusionDirector.1.0.SwitchProfileError99": {
        "Message": "此逻辑交换机的MonitorLink资源使用数量已达到最大值(%1)",
        "NumberOfArgs": 1,
        "Resolution": "MonitorLink资源使用数量已达到最大值，请勿再使能MonitorLink功能"
    },
    "FusionDirector.1.0.SwitchProfileError100": {
        "Message": "%1已经被网络(%2)的zone关联",
        "NumberOfArgs": 2,
        "Resolution": "请先取消关联"
    },
    "FusionDirector.1.0.NodeGroupBeOperated": {
        "Message": "已有分组正在操作,当前不支持操作",
        "NumberOfArgs": 0,
        "Resolution": "请等待当前分组操作完成后再尝试操作"
    },
    "FusionDirector.1.0.DeviceModelMEZZCheckErr": {
        "Message": "此机型不支持配置MEZZ卡",
        "NumberOfArgs": 0,
        "Resolution": "请检查设备模型以及MEZZ卡参数后重新提交请求"
    },
    "FusionDirector.1.0.DeviceModelChangeErr": {
        "Message": "此设备模型已关联设备或上线规划，关联详情请在设备模型列表查看。",
        "NumberOfArgs": 0,
        "Resolution": "请确认该设备模型未用于上线规划、服务器配置文件或设备中，再重新提交请求。"
    },
    "FusionDirector.1.0.ServerProfileChangeErr": {
        "Message": "此服务器配置文件用于%1的%2中",
        "NumberOfArgs": 2,
        "Resolution": "请确认该服务器配置文件未用于上线规划或设备中，再重新提交请求"
    },
    "FusionDirector.1.0.DeviceModelResourceRepeat": {
        "Message": "服务检测到资源%1重复",
        "NumberOfArgs": 1,
        "Resolution": "请修改参数后重新提交请求"
    },
    "FusionDirector.1.0.LicenseUnsupported": {
        "Message": "不支持的许可证。",
        "NumberOfArgs": 0,
        "Resolution": "请提供合法的许可证，然后重试。"
    },
    "FusionDirector.1.0.LicenseESNMismatch": {
        "Message": "许可证与系统的ESN不匹配。",
        "NumberOfArgs": 0,
        "Resolution": "请导入与系统ESN匹配的许可证。如果申请许可证的ESN填写错误，请在ESDP平台变更许可证的ESN或联系华为技术支持工程师。"
    },
    "FusionDirector.1.0.LicenseVerifyFailed": {
        "Message": "许可证校验失败，非法许可证。",
        "NumberOfArgs": 0,
        "Resolution": "请提供合法的许可证，然后重试。"
    },
    "FusionDirector.1.0.LicenseExpired": {
        "Message": "许可证激活时间已过期。",
        "NumberOfArgs": 0,
        "Resolution": "请联系华为技术支持工程师，获取新的许可证进行激活。"
    },
    "FusionDirector.1.0.LicenseInvalidFile": {
        "Message": "许可证已失效。",
        "NumberOfArgs": 0,
        "Resolution": "请在ESDP平台激活许可证或联系华为技术支持工程师。"
    },
    "FusionDirector.1.0.LicenseVersionMismatch": {
        "Message": "许可证版本不匹配",
        "NumberOfArgs": 0,
        "Resolution": "请导入与系统版本匹配的许可证，如果没有版本匹配的许可证，请联系华为技术支持工程师。"
    },
    "FusionDirector.1.0.DeployModelChangeError": {
        "Message": "此os部署模板用于%1的%2中",
        "NumberOfArgs": 2,
        "Resolution": "请确认该os部署模板未用于上线规划或设备部署，并再次提交请求"
    },
    "FusionDirector.1.0.ImageModelChangeError": {
        "Message": "此os镜像用于%1的%2中",
        "NumberOfArgs": 2,
        "Resolution": "请确认该os镜像未用于上线规划或设备部署，并再次提交请求"
    },
    "Fusiondirector.1.0.InsufficientPartPrivilege": {
        "Message": "当前用户或者会话不拥有%1内全部%2的作用域权限",
        "NumberOfArgs": 2,
        "Resolution": "放弃本次操作或添加资源到当前用户的作用域然后重新提交。"
    },

    'FusionDirector.1.0.PlanningServiceScopeURIInvalid': {
        "Message": "作用域URI %1无效。",
        "NumberOfArgs": 1,
        "Resolution": "请确保作用域URI正确，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceAssetDifferent': {
        "Message": "资产核查结果显示设备模型信息和真实设备信息不同，详情请参考链接%1。",
        "NumberOfArgs": 1,
        "Resolution": "请确保设备模型和真实设备信息一致，然后重试。"
    },

    'FusionDirector.1.0.PlanningServiceDeviceIsAlreadyGoverned': {
        "Message": "请求的IP地址%1和系统中已纳管设备的IP地址冲突。",
        "NumberOfArgs": 1,
        "Resolution": "请输入正确的IP地址，确保和系统中已纳管设备的IP地址不冲突。"
    },

    'FusionDirector.1.0.PlanningServiceForbiddenModifyAccount': {
        "Message": "%1任务阶段不允许修改用户名。",
        "NumberOfArgs": 1,
        "Resolution": "请确保没有对用户名进行修改，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceForbiddenModifyIP': {
        "Message": "当前任务阶段不允许修改IP地址",
        "NumberOfArgs": 0,
        "Resolution": "请确保没有对IP地址进行修改，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceForbiddenModifyPortOrProtocol': {
        "Message": "当前任务阶段不允许修改端口和协议类型。",
        "NumberOfArgs": 0,
        "Resolution": "请确保没有对端口和协议类型进行修改，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceForbiddenModifyProfile': {
        "Message": "当前任务阶段不允许修改服务器配置文件。",
        "NumberOfArgs": 0,
        "Resolution": "请确保没有对服务器配置文件进行修改，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceForbiddenModifyDeployModel': {
        "Message": "当前任务阶段不允许修改部署模板。",
        "NumberOfArgs": 0,
        "Resolution": "请确保没有对部署模板进行修改，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceForbiddenModifySN': {
        "Message": "%1任务阶段不允许修改SN。",
        "NumberOfArgs": 1,
        "Resolution": "请确保没有对SN进行修改，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceForbiddenModifyMac': {
        "Message": "%1任务阶段不允许修改MAC地址。",
        "NumberOfArgs": 1,
        "Resolution": "请确保没有对MAC地址进行修改，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceTemplateURLEmpty': {
        "Message": "服务器规划模板URL为空。",
        "NumberOfArgs": 0,
        "Resolution": "修改请求体中的服务器规划模板URL，然后重试。"
    },

    'FusionDirector.1.0.PlanningServicePlanningTypeError': {
        "Message": "规划类型%1错误。",
        "NumberOfArgs": 1,
        "Resolution": "请提供有效的规划类型，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceNameAlreadyExists': {
        "Message": "名称%1已使用。",
        "NumberOfArgs": 1,
        "Resolution": "请提供有效的名称，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceNameFormatError': {
        "Message": "名称%1格式错误。",
        "NumberOfArgs": 1,
        "Resolution": "请提供有效的名称，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceDescriptionFormatError': {
        "Message": "描述信息%1格式错误。",
        "NumberOfArgs": 1,
        "Resolution": "请提供有效的描述信息，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceFilterFormatError': {
        "Message": "过滤参数%1格式错误。",
        "NumberOfArgs": 1,
        "Resolution": "请提供有效的过滤参数，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceServerIPDuplication': {
        "Message": "第%2行与%3行服务器规划模板IP地址%1重复。",
        "NumberOfArgs": 3,
        "Resolution": "请提供有效的服务器规划模板IP地址，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceServerSNDuplication': {
        "Message": "第%2行与%3行服务器规划模板SN号%1重复。",
        "NumberOfArgs": 3,
        "Resolution": "请提供有效的服务器规划模板SN，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceServerMacDuplication': {
        "Message": "第%2行与%3行服务器规划模板Mac地址%1重复。",
        "NumberOfArgs": 3,
        "Resolution": "请提供有效的服务器规划模板MAC地址，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceMacAndSnIsEmpty': {
        "Message": "服务器规划模板中的SN和MAC地址不能同时为空。",
        "NumberOfArgs": 0,
        "Resolution": "请提供有效的MAC地址或SN，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceNotAllowLocation': {
        "Message": "服务器规划模板不允许填写位置信息。",
        "NumberOfArgs": 0,
        "Resolution": "请不要在此服务器规划模板中填写位置信息，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceDeviceModelNameError': {
        "Message": "设备模型中的设备型号%1和服务器规划模板产品名称%2不匹配。",
        "NumberOfArgs": 2,
        "Resolution": "请提供和服务器规划模板产品名称匹配的设备模型，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceDeviceModelInvalid': {
        "Message": "服务器规划模板中的设备模型无效。",
        "NumberOfArgs": 0,
        "Resolution": "请提供有效的设备模型，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceDataCenterInvalid': {
        "Message": "服务器规划模板中的数据中心信息无效。",
        "NumberOfArgs": 0,
        "Resolution": "请提供有效的数据中心信息，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceIDPoolInvalid': {
        "Message": "服务器规划模板中的ID池信息无效。",
        "NumberOfArgs": 0,
        "Resolution": "请提供有效的ID池信息，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceTemplateIDError': {
        "Message": "服务器规划模板ID%1错误",
        "NumberOfArgs": 1,
        "Resolution": "请提供有效的服务器规划模板ID，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceServerTemplateInUse': {
        "Message": "服务器规划模板正在使用，ID为%1。",
        "NumberOfArgs": 1,
        "Resolution": "请提供有效的服务器规划模板，然后重试。"
    },
    'FusionDirector.1.0.PlanningServicePlanningTemplateNotExists': {
        "Message": "规划模板%1不存在。",
        "NumberOfArgs": 1,
        "Resolution": "请提供有效的规划模板，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceServerTemplateNotExists': {
        "Message": "服务器规划模板%1不存在。",
        "NumberOfArgs": 1,
        "Resolution": "请提供有效的服务器规划模板，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceDeployModelInvalid': {
        "Message": "部署模板%1无效。",
        "NumberOfArgs": 1,
        "Resolution": "请其他有效的部署模板，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceDeployAndDeviceModelNotMatch': {
        "Message": "部署模板%1和设备模型不匹配。",
        "NumberOfArgs": 1,
        "Resolution": "请提供有效的部署模板，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceProfileNotExist': {
        "Message": "服务器配置文件%1不存在。",
        "NumberOfArgs": 1,
        "Resolution": "请提供有效的服务器配置文件，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceProfileAndDeviceModelNotMatch': {
        "Message": "服务器配置文件%1和设备模型不匹配。",
        "NumberOfArgs": 1,
        "Resolution": "请提供有效的服务器配置文件，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceProductNameInvalid': {
        "Message": "服务器规划模板产品名称无效。",
        "NumberOfArgs": 0,
        "Resolution": "请提供有效的服务器规划模板产品名称，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceUserNameInvalid': {
        "Message": "用户名参数%1无效。",
        "NumberOfArgs": 0,
        "Resolution": "请提供有效的用户名，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceOldPasswordInvalid': {
        "Message": "旧密码参数无效。",
        "NumberOfArgs": 0,
        "Resolution": "请提供有效的密码，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceNewPasswordInvalid': {
        "Message": "新密码参数无效。",
        "NumberOfArgs": 0,
        "Resolution": "请确保新密码是有效且和旧密码不同，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceServerLocationDuplication': {
        "Message": "服务器位置信息%1不能重复。",
        "NumberOfArgs": 1,
        "Resolution": "请提供有效的服务器位置信息，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceRackInvalid': {
        "Message": "机柜参数%1无效。",
        "NumberOfArgs": 1,
        "Resolution": "请提供有效的机柜参数，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceIPGatewayFormatError': {
        "Message": "网关地址%1格式错误。",
        "NumberOfArgs": 1,
        "Resolution": "请提供有效的网关地址，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceIPAddressFormatError': {
        "Message": "IP地址%1格式错误。",
        "NumberOfArgs": 1,
        "Resolution": "请提供有效的IP地址，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceIPSubnetMaskFormatError': {
        "Message": "子网掩码%1格式错误。",
        "NumberOfArgs": 1,
        "Resolution": "请提供有效的子网掩码，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceMacAddressFormatError': {
        "Message": "MAC地址%1格式错误。",
        "NumberOfArgs": 1,
        "Resolution": "请提供有效的MAC地址，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceProtocolFormatError': {
        "Message": "协议类型%1格式错误。",
        "NumberOfArgs": 1,
        "Resolution": "请提供有效的协议类型，然后重试。"
    },
    'FusionDirector.1.0.PlanningServicePortFormatError': {
        "Message": "端口%1格式错误。",
        "NumberOfArgs": 1,
        "Resolution": "请提供有效的端口，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceIPAddressNotSameNetworkError': {
        "Message": "IP地址%1、网关%2和子网掩码%3网段不同。",
        "NumberOfArgs": 3,
        "Resolution": "请确保IP地址、网关和子网掩码处于同一网段，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceSyncDeviceReadyStatusTimeout': {
        "Message": "同步设备%1纳管状态超时。",
        "NumberOfArgs": 1,
        "Resolution": "请对该服务器规划模板进行重试。"
    },
    'FusionDirector.1.0.PlanningDeviceIsAlreadyBinding': {
        "Message": "设备%1已经绑定了服务器配置文件%2，不允许再次绑定。",
        "NumberOfArgs": 2,
        "Resolution": "请将设备和服务器配置文件解绑，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceSkipFlagValuesNotConsistent': {
        "Message": "批量请求中此服务器规划模板的跳过标志%1和第一条服务器模板的跳过标志不一致。",
        "NumberOfArgs": 1,
        "Resolution": "请修改服务器规划模板跳过标志，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceResourceStatusNotMatchToOperate': {
        "Message": "资源当前处于%1状态，不允许做此操作。",
        "NumberOfArgs": 1,
        "Resolution": "请确保请求的资源当前的状态符合操作条件。"
    },
    'FusionDirector.1.0.PlanningServiceResourceStageNotMatchToOperate': {
        "Message": "资源当前处于%1任务阶段，不允许做此操作。",
        "NumberOfArgs": 1,
        "Resolution": "请确保请求的资源当前的任务阶段符合操作条件。"
    },
    'FusionDirector.1.0.PlanningServiceSNNotMatch': {
        "Message": "服务器规划模板中的SN%1和真实设备的SN%2不匹配。",
        "NumberOfArgs": 2,
        "Resolution": "请将服务器规划模板中的SN修改为真实设备的SN，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceMACNotMatch': {
        "Message": "服务器规划模板中的MAC地址%1和真实设备的MAC地址%2不匹配。",
        "NumberOfArgs": 2,
        "Resolution": "请将服务器规划模板中的MAC地址修改为真实设备的MAC地址，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceApplyLocationError': {
        "Message": "服务器规划模板申请位置信息失败。",
        "NumberOfArgs": 0,
        "Resolution": "请确保请求的位置信息填写正确，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceForbiddenAddServerTemplate': {
        "Message": "规划模板%1已经包含了服务器规划模板，不允许再添加新的服务器规划模板。",
        "NumberOfArgs": 1,
        "Resolution": "请创建新的规划模板，然后将这些服务器规划模板添加进去。"
    },
    'FusionDirector.1.0.PlanningServiceProcessTimeout': {
        "Message": "%1任务阶段处理超时",
        "NumberOfArgs": 1,
        "Resolution": "请确保相关的服务器功能正常，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceRemoteCallServiceError': {
        "Message": "调用服务%1失败",
        "NumberOfArgs": 1,
        "Resolution": "请确保该服务功能正常，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceNoServerProfilePrivilege': {
        "Message": "与当前会话关联的账户或凭据没有足够权限配置服务器配置文件%1",
        "NumberOfArgs": 1,
        "Resolution": "请确保与当前会话关联的账户或凭据有足够权限配置该服务器配置文件。"
    },
    'FusionDirector.1.0.EventGetPasscodeErr': {
        "Message": "获取验证码失败。",
        "NumberOfArgs": 0,
        "Resolution": "请排查SMTP发件人邮箱信息是否配置正确。"
    },
    'FusionDirector.1.0.LicenseResourceExtendingLimit': {
        "Message": "License文件中已购买的服务器容量小于当前系统中已纳管服务器数量。",
        "NumberOfArgs": 0,
        "Resolution": "请删除系统中不使用的服务器或扩容此License文件使之不小于当前系统已纳管服务器数量。"
    },
    'FusionDirector.1.0.PlanningServiceServerIPExistInDB': {
        "Message": "第%3行规划服务器模板IP地址%1已在规划模板%2中存在。",
        "NumberOfArgs": 3,
        "Resolution": "请提供有效的服务器规划模板IP地址，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceServerSNExistInDB': {
        "Message": "第%3行规划服务器模板SN号%1已在规划模板%2中存在。",
        "NumberOfArgs": 3,
        "Resolution": "请提供有效的服务器规划模板SN号，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceServerMacExistInDB': {
        "Message": "第%3行规划服务器模板Mac地址%1已在规划模板%2中存在。",
        "NumberOfArgs": 3,
        "Resolution": "请提供有效的服务器规划模板Mac地址，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceServerIPGoverned': {
        "Message": "第%2行规划服务器模板IP地址%1已在网络中存在。",
        "NumberOfArgs": 2,
        "Resolution": "请提供有效的服务器规划模板IP地址，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceServerSNGoverned': {
        "Message": "第%2行规划服务器模板SN号%1已在网络中存在。",
        "NumberOfArgs": 2,
        "Resolution": "请提供有效的服务器规划模板SN号，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceServerMacGoverned': {
        "Message": "第%2行规划服务器模板Mac地址%1已在网络中存在。",
        "NumberOfArgs": 2,
        "Resolution": "请提供有效的服务器规划模板Mac地址，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceServerIPConflict': {
        "Message": "IP %1 已在网络中存在。",
        "NumberOfArgs": 1,
        "Resolution": "请提供有效的服务器规划模板IP地址，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceDeviceModelNotMatch': {
        "Message": "规划模板的设备模型%1与真实设备的模型%2不匹配。",
        "NumberOfArgs": 2,
        "Resolution": "请确认设备是否插错位置，如果确定没有插错设备，需要重新规划正确的设备模型。"
    },
    'FusionDirector.1.0.PlanningServiceLocationNotMatch': {
        "Message": "规划模板的规划位置机柜%1的起始U位%2，结束U位%3,与实际设备的起始U位%4，结束U位%5，不匹配。",
        "NumberOfArgs": 5,
        "Resolution": "请确保设备插入正确的位置，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceNoDataCenterPrivilege': {
        "Message": "当前会话没有足够的权限配置数据中心%1。",
        "NumberOfArgs": 1,
        "Resolution": "请确保当前会话有权限配置数据中心，然后重试。"
    },
    'FusionDirector.1.0.PlanningServiceUserNameAndOldPasswordValueStatusInconsistent': {
        "Message": "用户名和密码需要同为空或者同时不为空。",
        "NumberOfArgs": 0,
        "Resolution": "请确保用户名和密码同时为空或者同时赋值。"
    },
    'FusionDirector.1.0.PlanningServiceDeviceNotFind': {
        "Message": "无法在机柜%1中找到起始U位为%2的设备。",
        "NumberOfArgs": 2,
        "Resolution": "请确保设备已插入并且是上线状态，然后重试。"
    },
    'FusionDirector.1.0.IAMAccountsReachNumLimit': {
        "Message": "创建用户失败，用户数量已达到最大限制。",
        "NumberOfArgs": 0,
        "Resolution": "删除用户或修改系统创建账户数量最大限制。"
    },
    'FusionDirector.1.0.IAMNameAlreadyExisted': {
        "Message": "当前%1已经存在，不能重复创建。",
        "NumberOfArgs": 1,
        "Resolution": "修改名称再次提交。"
    },
    'FusionDirector.1.0.DevDiscoverCategorysAreNotSame': {
        "Message": "不能在一次请求中导入不同种族的设备。",
        "NumberOfArgs": 0,
        "Resolution": "请修改正确后重试。"
    },
    'FusionDirector.1.0.ClusterNodeIPModifyNotFinished': {
        "Message": "ip正在修改中。",
        "NumberOfArgs": 0,
        "Resolution": "请在上次修改操作执行5分钟后重试。"
    },
    'FusionDirector.1.0.LicenseNotAvailable': {
        "Message": "License受限，该功能不可用。",
        "NumberOfArgs": 0,
        "Resolution": "请导入License文件后重试。"
    },
    'FusionDirector.1.0.ServerProfileNotMatch': {
        "Message": "设备与服务器配置文件分别对应的配置模型不匹配。",
        "NumberOfArgs": 0,
        "Resolution": "请重新创建符合当前上线设备的规划模板。"
    },
    'FusionDirector.1.0.ClusterInternalNetworksMismatch': {
        "Message": "待添加节点的预留私网段与集群预留私网段不匹配。",
        "NumberOfArgs": 0,
        "Resolution": "请单击右上角\"帮助\"，参考联机帮助的内容，将待添加节点或集群节点恢复出厂设置，重新配置部署，确认待添加节点的预留私网段与集群预留私网段匹配后，重新添加节点。"
    },
    'FusionDirector.1.0.AppConfigProxyAuthenticationErr': {
        "Message": "代理服务器身份验证失败。",
        "NumberOfArgs": 0,
        "Resolution": "请检查代理服务器用户名密码后，重新提交请求。"
    },
    'FusionDirector.1.0.BaseManagerIPPoolUnavailable': {
        "Message": "ENCLOSURE_ManagementIPPool没有可用的IP地址资源。",
        "NumberOfArgs": 0,
        "Resolution": "请确保ENCLOSURE_ManagementIPPool有可用的IP地址资源。"
    },
    'FusionDirector.1.0.BaseServiceIPPoolUnavailable': {
        "Message": "ENCLOSURE_ServiceIPPool没有可用的IP地址资源。",
        "NumberOfArgs": 0,
        "Resolution": "请确保ENCLOSURE_ServiceIPPool有可用的IP地址资源。"
    },
    'FusionDirector.1.0.VersionNotSupported': {
        "Message": "设备 %1 的版本 %2 不支持，支持的最低版本是 %3。",
        "NumberOfArgs": 3,
        "Resolution": "请升级设备后重新提交请求。"
    },
    'FusionDirector.1.0.PropertyValueInvalid': {
        "Message": "属性%2的值%1无效。",
        "NumberOfArgs": 2,
        "Resolution": "更正请求正文，并在请求失败时重新提交。"
    },
    'FusionDirector.1.0.PropertyConflict': {
        "Message": "属性%2的值%1与资源%4的属性%3冲突。",
        "NumberOfArgs": 4,
        "Resolution": "确保请求的属性有效，并在请求失败时重新提交。"
    },
    'FusionDirector.1.0.ResourceNotEnough': {
        "Message": "资源%1不足。",
        "NumberOfArgs": 1,
        "Resolution": "确保资源充足，并在请求失败时重新提交。"
    },
    'FusionDirector.1.0.PropertyValueOutOfRange': {
        "Message": "属性%2的值%1超出范围%3。",
        "NumberOfArgs": 3,
        "Resolution": "确保请求的属性有效，并在请求失败时重新提交。"
    },
    'FusionDirector.1.1.OperationNotSupportedOnState': {
        "Message": "资源%1当前的状态不支持该操作。",
        "NumberOfArgs": 1,
        "Resolution": "请等待对象处于合适的状态后再尝试此操作。"
    },
    "Base.1.4.ResourceExhaustion": {
        "Message": "请求所需的资源%1不可用。",
        "NumberOfArgs": 1,
        "Resolution": "确认相应资源是否可用后重试。"
    },
    "iBMC.1.0.AuthorizationFailed": {
        "Message": "当前用户密码错误或账户已锁定。",
        "NumberOfArgs": 0,
        "Resolution": "请使用正确的用户名密码或账户解锁后重试。"
    },
    "iBMC.1.0.IPv4AddressConflict": {
        "Message": "IPv4地址与网关地址不匹配或与其他组的IPv4地址冲突。",
        "NumberOfArgs": 0,
        "Resolution": "请确保IPv4地址与网关地址匹配且和其他组中的所有IPv4地址不同。"
    },
    "iBMC.1.0.ActionParameterValueInvalid": {
        "Message": "请求参数%2的值%1是无效的。",
        "NumberOfArgs": 2,
        "Resolution": "请使用正确的参数值重试。"
    },
    'FusionDirector.1.0.CertCannotCreateChain': {
        "Message": "无法为给定证书生成有效的证书链，链中的一个或多个证书可能未添加。",
        "NumberOfArgs": 0,
        "Resolution": "检查所需的CA证书是否已经添加到系统信任存储并且有效。"
    },
    'FusionDirector.1.0.PowerServerNotInSameRack': {
        "Message": "参数中的服务器不属于一个机柜。",
        "NumberOfArgs": 0,
        "Resolution": "修改服务器参数，重新提交。"
    },
    'FusionDirector.1.0.PowerRackCappingDisable': {
        "Message": "服务器所在的机柜未开启功耗封顶功能。",
        "NumberOfArgs": 0,
        "Resolution": "开启机柜功耗封顶参数，重新提交。"
    },
    'FusionDirector.1.0.RackLocationConflict': {
        "Message": "机柜位置冲突",
        "NumberOfArgs": 0,
        "Resolution": "请确保同一数据中心下的机柜位置不重复，并重新提交请求"
    },
    'FusionDirector.1.0.BackupCheckCPackageError': {
        "Message": "备份包校验失败。",
        "NumberOfArgs": 0,
        "Resolution": "请检查备份包的格式和完整性，再重新上传。"
    },
    'FusionDirector.1.0.UpgradeCheckCPackageError': {
        "Message": "系统升级包校验失败",
        "NumberOfArgs": 0,
...
var errorCode_en = {
    ...
    //http
    "-50002": "Please add a FusionDirector on FusionDirector page first.",
    ...
    "Base.1.0.ResourceMissingAtURI": {
        ...
        "NumberOfArgs": 0,
        "Resolution": "Check whether the resource has been deleted or changed."
    },
    "Base.1.0.ResourceAtUriInUnknownFormat": {
    ...
    "FusionDirector.1.0.EventSenderMailAddrErr": {
        "Message": "The IP address or port number of the SMTP server is incorrect.",
        "NumberOfArgs": 0,
        "Resolution": "Reconfigure the IP address and port number of the SMTP server to the correct ones."
    },
    "FusionDirector.1.0.EventMailCertErr": {
    ...
    "FusionDirector.1.0.AppConfigDNSServerAuthenticationErr": {
        ...
        "NumberOfArgs": 0,
        "Resolution": "Ensure that the DNS server supports external configuration operations, check the DNS authentication information, and try again."
    },
    "FusionDirector.1.0.AppConfigDNSServerKeyErr": {
        "Message": "The key value of the DNS server is incorrect.",
        "NumberOfArgs": 0,
        "Resolution": "Enter a valid DNS key value and try again."
    },
    "FusionDirector.1.0.AppConfigPartSuccess": {
        "Message": "Some operations may fail.",
        "NumberOfArgs": 0,
        "Resolution": "Ensure that both DNS servers are valid and try again."
    },
    "FusionDirector.1.0.AppConfigDeleteDNSServerFailed": {
        "Message": "Failed to delete the DNS server.",
        "NumberOfArgs": 0,
        "Resolution": "Ensure that the DNS server is valid and try again."
    },
    "FusionDirector.1.0.IAMPasswordExpired": {
    ...
    "FusionDirector.1.0.ClusterNetworkDomainsMismatch": {
        "Message": "The network plane of the node to be added does not match that of the cluster.",
        "NumberOfArgs": 0,
        "Resolution": "Restore the nodes or cluster nodes to be added to factory settings, and reconfigure the nodes. Check that the network plane of the nodes to be added matches that of the cluster, and add the nodes again. For details, see the help information."
    },
    "FusionDirector.1.0.ClusterNTPServerEmpty": {
    ...
    "FusionDirector.1.0.UpgradeAlreadyHasPlan": {
        "Message": "The device %1 has been bound to the schedule %2.",
        "NumberOfArgs": 2,
        "Resolution": "Wait until the original schedule is complete or disabled."
    },
    "FusionDirector.1.0.EnclosureTempProfileNotSupport": {
    ...
    "FusionDirector.1.0.DeployServiceNullPreHostName": {
        "Message": "The hostname prefix is not configured.",
        "NumberOfArgs": 0,
        "Resolution": "Configure the hostname prefix and try again."
    },
    "FusionDirector.1.0.DeployServiceNullPartitionPara": {
    ...
    "FusionDirector.1.0.SwitchProfileError17": {
        "Message": "The network does not support the untaged VLAN.",
        "NumberOfArgs": 0,
        "Resolution": "Do not set the network as the untaged VLAN."
    },
    "FusionDirector.1.0.SwitchProfileError18": {
        "Message": "Only one untaged VLAN can be set for a port.",
        "NumberOfArgs": 0,
        "Resolution": "Do not set multiple untaged VLANs on a port."
    },
    "FusionDirector.1.0.SwitchProfileError19": {
    ...
    "FusionDirector.1.0.SwitchProfileError22": {
        "Message": "The FCoE VLAN IDs of the uplink and downlink ports cannot be the same.",
        "NumberOfArgs": 0,
        "Resolution": "Ensure that the FCoE VLAN IDs of the uplink and downlink ports are different."
    },
    "FusionDirector.1.0.SwitchProfileError23": {
    ...
    "FusionDirector.1.0.SwitchProfileError75": {
        "Message": "The server network ports connected to the same internal link aggregation group must use the same untaged VLAN ID.",
        "NumberOfArgs": 0,
        "Resolution": "Ensure that the same untaged VLAN ID is used."
    },
    "FusionDirector.1.0.SwitchProfileError76": {
    ...
    "FusionDirector.1.0.SwitchProfileError81": {
        "Message": "The network connected to the internal EthTrunk cannot be set to the untaged VLAN and taged VLAN at the same time.",
        "NumberOfArgs": 0,
        "Resolution": "Do not set the same network to the untaged VLAN and taged VLAN at the same time."
    },
    "FusionDirector.1.0.SwitchProfileError82": {
    ...
    "FusionDirector.1.0.IAMTestLDAPControllerFailed": {
        "Message": "Failed to test the connectivity of the domain controller %1.",
        "NumberOfArgs": 1,
        "Resolution": "Ensure that the domain controller information is correctly configured and try again."
    },
    "FusionDirector.1.0.IAMAuthenticationFailure": {
        "Message": "The user name or password of the domain controller %1 is incorrect.",
        "NumberOfArgs": 1,
        "Resolution": "Enter the correct user name or password and try again."
    },
    "FusionDirector.1.0.DevMgmtServerNotExist": {
        "Message": "The target server does not exist.",
        "NumberOfArgs": 0,
        "Resolution": "Check the server status."
    },
    "FusionDirector.1.0.DevMgmtTaskNotExist": {
        "Message": "The target task does not exist.",
        "NumberOfArgs": 0,
        "Resolution": "Refresh the task and try again."
    },
    "FusionDirector.1.0.DevMgmtPartSuccess": {
        "Message": "The operations are partially successful.",
        "NumberOfArgs": 0,
        "Resolution": "Please try again. If the fault persists, contact technical support."
    },
    "FusionDirector.1.0.QueryParameterExcessLimit": {
        "Message": "The number of %1 parameters to be queried exceeds %2.",
        "NumberOfArgs": 2,
        "Resolution": "Decrease the number of parameters and try again."
    },
    "FusionDirector.1.0.ClusterVerifyHostFailed": {
        "Message": "The remote backup configuration cannot be verified.",
        "NumberOfArgs": 0,
        "Resolution": "Make sure that the username and password are set correctly, and the user has the write permission to the folder in the remote backup location."
    },
    "FusionDirector.1.0.ClusterGetKeyInfoFailed": {
        "Message": "Failed to obtain the SSH information. The public key cannot be generated for the remote server.",
        "NumberOfArgs": 0,
        "Resolution": "Enter a valid remote hostname or IP address and try again."
    },
    "FusionDirector.1.0.AppConfigDNSServerCheckErr": {
        "Message": "The domain name or the DNS server is abnormal.",
        "NumberOfArgs": 0,
        "Resolution": "Check the  domain name or DNS server and try again."
    },
    "FusionDirector.1.0.ModifyiBMCAccountNotSupportedOnState": {
        "Message": "The current state of the device %1 does not allow you to change the iBMC password.",
        "NumberOfArgs": 1,
        "Resolution": "Wait until the device is in a proper state and try again."
    },
    "FusionDirector.1.0.BMCAuthenticationFailure": {
        "Message": "Authentication failed when accessing the iBMC.",
        "NumberOfArgs": 0,
        "Resolution": "Enter valid authentication information and try again."
    },
    "FusionDirector.1.0.DeployServiceNullPartitionFilesystem": {
        "Message": "The customized partition file system does not match.",
        "NumberOfArgs": 0,
        "Resolution": "Select another partition file system and try again."
    },
    "FusionDirector.1.0.DeployServiceNullSurpportPartition": {
        "Message": "The subtype of this type does not support customized partitions.",
        "NumberOfArgs": 0,
        "Resolution": "Select the automatic partitioning mode and try again."
    },
    "FusionDirector.1.0.SwitchProfileError99": {
        "Message": "The number of used MonitorLink resources of the logical switch has reached the maximum value (%1).",
        "NumberOfArgs": 1,
        "Resolution": "Do not enable the MonitorLink function again."
    },
    "FusionDirector.1.0.SwitchProfileError100": {
        "Message": "%1 has been associated by the zone of the network (%2).",
        "NumberOfArgs": 2,
        "Resolution": "Cancel the association first."
    },
    "FusionDirector.1.0.NodeGroupBeOperated": {
        "Message": "A group is being created. The operation is not supported at present.",
        "NumberOfArgs": 0,
        "Resolution": "Try again after the group is created."
    },
    "FusionDirector.1.0.DeviceModelMEZZCheckErr": {
        "Message": "This model does not support mezzanine cards.",
        "NumberOfArgs": 0,
        "Resolution": "Check the device model and mezzanine card parameters and submit the request again."
    },
    "FusionDirector.1.0.DeviceModelChangeErr": {
        "Message": "The device model has been associated with a device or installation plan. For details, see the device model list.",
        "NumberOfArgs": 0,
        "Resolution": "Check that the device model is not used in installation plans, server profiles, or devices, and submit the request again."
    },
    "FusionDirector.1.0.ServerProfileChangeErr": {
        "Message": "This server profile is used in the %2 of %1.",
        "NumberOfArgs": 2,
        "Resolution": "Check that the server profile is not used in installation plans or devices, and submit the request again."
    },
    "FusionDirector.1.0.DeviceModelResourceRepeat": {
        "Message": "The service detects that the %1 resource is duplicate.",
        "NumberOfArgs": 1,
        "Resolution": "Modify the parameters and submit the request again."
    },
    "FusionDirector.1.0.LicenseUnsupported": {
        "Message": "The license is not supported.",
        "NumberOfArgs": 0,
        "Resolution": "Import a valid license and try again."
    },
    "FusionDirector.1.0.LicenseESNMismatch": {
        "Message": "The license file does not match the system ESN.",
        "NumberOfArgs": 0,
        "Resolution": "Import a license file that matches the system ESN. If the ESN used to apply for the license file is incorrect, change the ESN of the license file on the ESDP or contact Huawei technical support."
    },
    "FusionDirector.1.0.LicenseVerifyFailed": {
        "Message": "Failed to verify the license file because the license file is invalid.",
        "NumberOfArgs": 0,
        "Resolution": "Import a valid license and try again."
    },
    "FusionDirector.1.0.LicenseExpired": {
        "Message": "The license file activation time is due.",
        "NumberOfArgs": 0,
        "Resolution": "Contact Huawei technical support to obtain a new license file and activate it."
    },
    "FusionDirector.1.0.LicenseInvalidFile": {
        "Message": "The license file has expired.",
        "NumberOfArgs": 0,
        "Resolution": "Activate the license file on the ESDP or contact Huawei technical support."
    },
    "FusionDirector.1.0.LicenseVersionMismatch": {
        "Message": "The license file version does not match.",
        "NumberOfArgs": 0,
        "Resolution": "Import a license file that matches the system version. If the license file does not match the system version, contact Huawei technical support."
    },
    "FusionDirector.1.0.DeployModelChangeError": {
        "Message": "This OS deployment template is used in %2 of %1.",
        "NumberOfArgs": 2,
        "Resolution": "Ensure that the OS deployment template has not been used for online planning or device deployment and submit the request again."
    },
    "FusionDirector.1.0.ImageModelChangeError": {
        "Message": "This OS image is used in the %2 of %1.",
        "NumberOfArgs": 2,
        "Resolution": "Ensure that the OS image has not been used for online planning or device deployment, and submit the request again."
    },
    "Fusiondirector.1.0.InsufficientPartPrivilege": {
        "Message": "The current user or session does not have the scope permission of all %2s in %1.",
        "NumberOfArgs": 2,
        "Resolution": "Cancel the operation or add resources to the scope of the current user, and then submit the request again."
    },
    'FusionDirector.1.0.EventGetPasscodeErr': {
        "Message": "Failed to obtain the verification code.",
        "NumberOfArgs": 0,
        "Resolution": "Check that the sender email address is correctly configured."
    },
    'FusionDirector.1.0.LicenseResourceExtendingLimit': {
        "Message": "The number of servers allowed by the license is less than the number of servers that have been managed in the system.",
        "NumberOfArgs": 0,
        "Resolution": "Delete the servers that are not used in the system or use a license that supports more servers."
    },

    'FusionDirector.1.0.PlanningServiceScopeURIInvalid': {
        "Message": "The scope URI %1 is invalid.",
        "NumberOfArgs": 1,
        "Resolution": "Ensure that the scope URI is correct and try again."
    },
    'FusionDirector.1.0.PlanningServiceAssetDifferent': {
        "Message": "The asset check result shows that the device model is different from the actual device model. For details, see %1.",
        "NumberOfArgs": 1,
        "Resolution": "Ensure that the device model is consistent with the actual device model and try again."
    },

    'FusionDirector.1.0.PlanningServiceDeviceIsAlreadyGoverned': {
        "Message": "The requested IP address %1 conflicts with the IP address of a managed device in the system.",
        "NumberOfArgs": 1,
        "Resolution": "Enter a correct IP address that does not conflict with the IP address of the managed device in the system."
    },

    'FusionDirector.1.0.PlanningServiceForbiddenModifyAccount': {
        "Message": "The username cannot be changed in the %1 task phase.",
        "NumberOfArgs": 1,
        "Resolution": "Ensure that the username is not changed and try again."
    },
    'FusionDirector.1.0.PlanningServiceForbiddenModifyIP': {
        "Message": "The IP address cannot be changed in the current task phase.",
        "NumberOfArgs": 0,
        "Resolution": "Ensure that the IP address is not changed and try again."
    },
    'FusionDirector.1.0.PlanningServiceForbiddenModifyPortOrProtocol': {
        "Message": "The port and protocol type cannot be changed in the current task phase.",
        "NumberOfArgs": 0,
        "Resolution": "Ensure that the port and protocol type are not modified and try again."
    },
    'FusionDirector.1.0.PlanningServiceForbiddenModifyProfile': {
        "Message": "The server profile cannot be modified in the current task phase.",
        "NumberOfArgs": 0,
        "Resolution": "Ensure that the server profile is not modified and try again."
    },
    'FusionDirector.1.0.PlanningServiceForbiddenModifyDeployModel': {
        "Message": "The deployment template cannot be modified during the current task phase.",
        "NumberOfArgs": 0,
        "Resolution": "Ensure that the deployment template is not modified and try again."
    },
    'FusionDirector.1.0.PlanningServiceForbiddenModifySN': {
        "Message": "The SN cannot be changed in the %1 task phase.",
        "NumberOfArgs": 1,
        "Resolution": "Ensure that the SN is not changed and try again."
    },
    'FusionDirector.1.0.PlanningServiceForbiddenModifyMac': {
        "Message": "The MAC address cannot be changed in the %1 task phase.",
        "NumberOfArgs": 1,
        "Resolution": "Ensure that the MAC address is not changed and try again."
    },
    'FusionDirector.1.0.PlanningServiceTemplateURLEmpty': {
        "Message": "The URL of the server plan template is empty.",
        "NumberOfArgs": 0,
        "Resolution": "Modify the URL of the server plan template in the request body and try again."
    },

    'FusionDirector.1.0.PlanningServicePlanningTypeError': {
        "Message": "The plan type %1 is incorrect.",
        "NumberOfArgs": 1,
        "Resolution": "Provide a valid plan type and try again."
    },
    'FusionDirector.1.0.PlanningServiceNameAlreadyExists': {
        "Message": "The name %1 is in use.",
        "NumberOfArgs": 1,
        "Resolution": "Provide a valid name and try again."
    },
    'FusionDirector.1.0.PlanningServiceNameFormatError': {
        "Message": "The format of the name %1 is incorrect.",
        "NumberOfArgs": 1,
        "Resolution": "Provide a valid name and try again."
    },
    'FusionDirector.1.0.PlanningServiceDescriptionFormatError': {
        "Message": "The format of the %1 description is incorrect.",
        "NumberOfArgs": 1,
        "Resolution": "Provide valid description and try again."
    },
    'FusionDirector.1.0.PlanningServiceFilterFormatError': {
        "Message": "The format of the filter parameter %1 is incorrect.",
        "NumberOfArgs": 1,
        "Resolution": "Provide valid filtering parameters and try again."
    },
    'FusionDirector.1.0.PlanningServiceServerIPDuplication': {
        "Message": "The IP address %1 is duplicate in the request on index %2 and %3.",
        "NumberOfArgs": 3,
        "Resolution": "Provide a valid IP address and try again."
    },
    'FusionDirector.1.0.PlanningServiceServerSNDuplication': {
        "Message": "The SN %1 is duplicate in the request on index %2 and %3.",
        "NumberOfArgs": 3,
        "Resolution": "Provide a valid SN and try again."
    },
    'FusionDirector.1.0.PlanningServiceServerMacDuplication': {
        "Message": "The MAC address %1 is duplicate in the request on index %2 and %3.",
        "NumberOfArgs": 3,
        "Resolution": "Provide a valid MAC address and try again."
    },
    'FusionDirector.1.0.PlanningServiceMacAndSnIsEmpty': {
        "Message": "The SN and MAC addresses in the server plan template cannot be empty at the same time.",
        "NumberOfArgs": 0,
        "Resolution": "Provide the valid MAC address and SN and try again."
    },
    'FusionDirector.1.0.PlanningServiceNotAllowLocation': {
        "Message": "Location information is not allowed in the server plan template.",
        "NumberOfArgs": 0,
        "Resolution": "Remove the location information from the server plan template and try again."
    },
    'FusionDirector.1.0.PlanningServiceDeviceModelNameError': {
        "Message": "The device model %1 does not match the product name %2 in the server plan template.",
        "NumberOfArgs": 2,
        "Resolution": "Provide a device model that matches the product name in the server plan template and try again."
    },
    'FusionDirector.1.0.PlanningServiceDeviceModelInvalid': {
        "Message": "The device model in the server plan template is invalid.",
        "NumberOfArgs": 0,
        "Resolution": "Provide a valid device model and try again."
    },
    'FusionDirector.1.0.PlanningServiceDataCenterInvalid': {
        "Message": "The data center information in the server plan template is invalid.",
        "NumberOfArgs": 0,
        "Resolution": "Provide valid data center information and try again."
    },
    'FusionDirector.1.0.PlanningServiceIDPoolInvalid': {
        "Message": "The ID pool information in the server plan template is invalid.",
        "NumberOfArgs": 0,
        "Resolution": "Provide valid ID pool information and try again."
    },
    'FusionDirector.1.0.PlanningServiceTemplateIDError': {
        "Message": "The server plan template ID %1 is incorrect.",
        "NumberOfArgs": 1,
        "Resolution": "Provide a valid server plan template ID and try again."
    },
    'FusionDirector.1.0.PlanningServiceServerTemplateInUse': {
        "Message": "The server plan template is in use and the ID is %1.",
        "NumberOfArgs": 1,
        "Resolution": "Provide a valid server plan template and try again."
    },
    'FusionDirector.1.0.PlanningServicePlanningTemplateNotExists': {
        "Message": "The plan template %1 does not exist.",
        "NumberOfArgs": 1,
        "Resolution": "Provide a valid plan template and try again."
    },
    'FusionDirector.1.0.PlanningServiceServerTemplateNotExists': {
        "Message": "The server plan template %1 does not exist.",
        "NumberOfArgs": 1,
        "Resolution": "Provide a valid server plan template and try again."
    },
    'FusionDirector.1.0.PlanningServiceDeployModelInvalid': {
        "Message": "The deployment template %1 is invalid.",
        "NumberOfArgs": 1,
        "Resolution": "Provide a valid deployment template and try again."
    },
    'FusionDirector.1.0.PlanningServiceDeployAndDeviceModelNotMatch': {
        "Message": "The deployment template %1 does not match the device model.",
        "NumberOfArgs": 1,
        "Resolution": "Provide a valid deployment template and try again."
    },
    'FusionDirector.1.0.PlanningServiceProfileNotExist': {
        "Message": "The server profile %1 does not exist.",
        "NumberOfArgs": 1,
        "Resolution": "Provide a valid server profile and try again."
    },
    'FusionDirector.1.0.PlanningServiceProfileAndDeviceModelNotMatch': {
        "Message": "The server profile %1 does not match the device model.",
        "NumberOfArgs": 1,
        "Resolution": "Provide a valid server profile and try again."
    },
    'FusionDirector.1.0.PlanningServiceProductNameInvalid': {
        "Message": "The product name in the server plan template is invalid.",
        "NumberOfArgs": 0,
        "Resolution": "Provide a valid server plan template product name and try again."
    },
    'FusionDirector.1.0.PlanningServiceUserNameInvalid': {
        "Message": "The username %1 is invalid.",
        "NumberOfArgs": 0,
        "Resolution": "Provide a valid user name and try again."
    },
    'FusionDirector.1.0.PlanningServiceOldPasswordInvalid': {
        "Message": "The old password is invalid.",
        "NumberOfArgs": 0,
        "Resolution": "Provide a valid password and try again."
    },
    'FusionDirector.1.0.PlanningServiceNewPasswordInvalid': {
        "Message": "The new password is invalid.",
        "NumberOfArgs": 0,
        "Resolution": "Ensure that the new password is valid and different from the old password, and try again."
    },
    'FusionDirector.1.0.PlanningServiceServerLocationDuplication': {
        "Message": "The server location information %1 must be unique.",
        "NumberOfArgs": 1,
        "Resolution": "Provide valid server location information and try again."
    },
    'FusionDirector.1.0.PlanningServiceRackInvalid': {
        "Message": "The rack %1 is invalid.",
        "NumberOfArgs": 1,
        "Resolution": "Provide a valid rack and try again."
    },
    'FusionDirector.1.0.PlanningServiceIPGatewayFormatError': {
        "Message": "The format of the gateway address %1 is incorrect.",
        "NumberOfArgs": 1,
        "Resolution": "Provide a valid gateway address and try again."
    },
    'FusionDirector.1.0.PlanningServiceIPAddressFormatError': {
        "Message": "The format of the IP address %1 is incorrect.",
        "NumberOfArgs": 1,
        "Resolution": "Provide a valid IP address and try again."
    },
    'FusionDirector.1.0.PlanningServiceIPSubnetMaskFormatError': {
        "Message": "The format of the subnet mask %1 is incorrect.",
        "NumberOfArgs": 1,
        "Resolution": "Provide a valid subnet mask and try again."
    },
    'FusionDirector.1.0.PlanningServiceMacAddressFormatError': {
        "Message": "The format of the MAC address %1 is incorrect.",
        "NumberOfArgs": 1,
        "Resolution": "Provide a valid MAC address and try again."
    },
    'FusionDirector.1.0.PlanningServiceProtocolFormatError': {
        "Message": "The format of the protocol type %1 is incorrect.",
        "NumberOfArgs": 1,
        "Resolution": "Provide a valid protocol type and try again."
    },
    'FusionDirector.1.0.PlanningServicePortFormatError': {
        "Message": "The format of the port %1 is incorrect.",
        "NumberOfArgs": 1,
        "Resolution": "Provide a valid port and try again."
    },
    'FusionDirector.1.0.PlanningServiceIPAddressNotSameNetworkError': {
        "Message": "The network segments of IP address %1, gateway %2, and subnet mask %3 are different.",
        "NumberOfArgs": 3,
        "Resolution": "Ensure that the IP address, gateway, and subnet mask are in the same network segment, and try again."
    },
    'FusionDirector.1.0.PlanningServiceSyncDeviceReadyStatusTimeout': {
        "Message": "Synchronizing the %1 management status of the device timed out.",
        "NumberOfArgs": 1,
        "Resolution": "Retry the server plan template."
    },
    'FusionDirector.1.0.PlanningDeviceIsAlreadyBinding': {
        "Message": "The server profile %2 has been bound to the device %1 and cannot be bound again.",
        "NumberOfArgs": 2,
        "Resolution": "Unbind the server profile from the device and try again."
    },
    'FusionDirector.1.0.PlanningServiceSkipFlagValuesNotConsistent': {
        "Message": "In the batch request, the skip flag %1 of the server plan template is inconsistent with that of the first server plan template.",
        "NumberOfArgs": 1,
        "Resolution": "Modify the skip flag of the server plan template and try again."
    },
    'FusionDirector.1.0.PlanningServiceResourceStatusNotMatchToOperate': {
        "Message": "This operation is not allowed when the resource is in the %1 state.",
        "NumberOfArgs": 1,
        "Resolution": "Ensure that the current status of the requested resource meets the operation conditions."
    },
    'FusionDirector.1.0.PlanningServiceResourceStageNotMatchToOperate': {
        "Message": "This operation is not allowed when the resource is in the %1 task phase.",
        "NumberOfArgs": 1,
        "Resolution": "Ensure that the current task phase of the requested resource meets the operation conditions."
    },
    'FusionDirector.1.0.PlanningServiceSNNotMatch': {
        "Message": "The value of SN %1 in the server plan template does not match the actual SN %2 of the device.",
        "NumberOfArgs": 2,
        "Resolution": "Change the SN in the server plan template to the actual SN of the device and try again."
    },
    'FusionDirector.1.0.PlanningServiceMACNotMatch': {
        "Message": "The MAC address %1 in the server plan template does not match the actual MAC address %2 of the device.",
        "NumberOfArgs": 2,
        "Resolution": "Change the MAC address in the server plan template to the actual MAC address of the device and try again."
    },
    'FusionDirector.1.0.PlanningServiceApplyLocationError': {
        "Message": "Failed to apply for location information in the server plan template.",
        "NumberOfArgs": 0,
        "Resolution": "Ensure that the requested location information is correct and try again."
    },
    'FusionDirector.1.0.PlanningServiceForbiddenAddServerTemplate': {
        "Message": "The plan template %1 contains the server plan template. Therefore, you are not allowed to add a new server plan template.",
        "NumberOfArgs": 1,
        "Resolution": "Create a plan template and add the server plan template to it."
    },
    'FusionDirector.1.0.PlanningServiceProcessTimeout': {
        "Message": "The processing in the %1 task phase times out.",
        "NumberOfArgs": 1,
        "Resolution": "Ensure that the related server functions properly and try again."
    },
    'FusionDirector.1.0.PlanningServiceRemoteCallServiceError': {
        "Message": "Failed to invoke the service %1.",
        "NumberOfArgs": 1,
        "Resolution": "Ensure that the service function is normal and try again."
    },
    'FusionDirector.1.0.PlanningServiceNoServerProfilePrivilege': {
        "Message": "The account or credential associated with the current session does not have sufficient permission to configure the server profile %1.",
        "NumberOfArgs": 1,
        "Resolution": "Ensure that the account or credential associated with the current session has sufficient permission to configure the server profile."
    },
    'FusionDirector.1.0.PlanningServiceServerIPExistInDB': {
        "Message": "The IP address %1 already exists in PlanningTemplate %2 on index %3.",
        "NumberOfArgs": 3,
        "Resolution": "Provide a valid IP address and try again."
    },
    'FusionDirector.1.0.PlanningServiceServerSNExistInDB': {
        "Message": "The SN %1 already exists in PlanningTemplate %2 on index %3.",
        "NumberOfArgs": 3,
        "Resolution": "Provide a valid SN address and try again."
    },
    'FusionDirector.1.0.PlanningServiceServerMacExistInDB': {
        "Message": "The Mac %1 already exists in PlanningTemplate %2 on index %3.",
        "NumberOfArgs": 3,
        "Resolution": "Provide a valid Mac address and try again."
    },
    'FusionDirector.1.0.PlanningServiceServerIPGoverned': {
        "Message": "The IP address %1 already exists in network on index %2.",
        "NumberOfArgs": 2,
        "Resolution": "Provide a valid IP address and try again."
    },
    'FusionDirector.1.0.PlanningServiceServerSNGoverned': {
        "Message": "The SN %1 already exists in network on index %2.",
        "NumberOfArgs": 2,
        "Resolution": "Provide a valid SN address and try again."
    },
    'FusionDirector.1.0.PlanningServiceServerMacGoverned': {
        "Message": "The Mac %1 already exists in network on index %2.",
        "NumberOfArgs": 2,
        "Resolution": "Provide a valid Mac address and try again."
    },
    'FusionDirector.1.0.PlanningServiceServerIPConflict': {
        "Message": "The IP address %1 already exists on the network.",
        "NumberOfArgs": 1,
        "Resolution": "Provide a valid IP address and try again."
    },
    'FusionDirector.1.0.PlanningServiceDeviceModelNotMatch': {
        "Message": "The device model %1 in the plan template does not match the actual device model %2.",
        "NumberOfArgs": 2,
        "Resolution": "Check whether the device is installed in the correct position. If the device is installed properly, plan the device model again."
    },
    'FusionDirector.1.0.PlanningServiceLocationNotMatch': {
        "Message": "The start U mark %2 and end U mark %3 of the rack %1 in the plan template do not match the actual start U mark %4 and end U mark %5.",
        "NumberOfArgs": 5,
        "Resolution": "Ensure that the device is installed in the correct position and try again."
    },
    'FusionDirector.1.0.PlanningServiceNoDataCenterPrivilege': {
        "Message": "The current session does not have sufficient permission to configure the data center %1.",
        "NumberOfArgs": 1,
        "Resolution": "Ensure that the current session has permission to configure the data center and try again."
    },
    'FusionDirector.1.0.PlanningServiceUserNameAndOldPasswordValueStatusInconsistent': {
        "Message": "The username and password must be both empty or neither is empty.",
        "NumberOfArgs": 0,
        "Resolution": "Ensure that the username and password are both empty or set at the same time."
    },
    'FusionDirector.1.0.PlanningServiceDeviceNotFind': {
        "Message": "The device whose start U mark is %2 cannot be found in the rack %1.",
        "NumberOfArgs": 2,
        "Resolution": "Ensure that the device has been installed and is in the online state, and try again."
    },
    'FusionDirector.1.0.IAMAccountsReachNumLimit': {
        "Message": "Failed to create the user because the number of users has reached the maximum.",
        "NumberOfArgs": 0,
        "Resolution": "Delete a user or change the maximum number of users that can be created in the system."
    },
    'FusionDirector.1.0.IAMNameAlreadyExisted': {
        "Message": "%1 already exists and cannot be created repeatedly.",
        "NumberOfArgs": 1,
        "Resolution": "Change the name and submit it again."
    },
    'FusionDirector.1.0.DevDiscoverCategorysAreNotSame': {
        "Message": "Devices of different categories cannot be imported in one request.",
        "NumberOfArgs": 0,
        "Resolution": "Correct the settings and try again."
    },
    'FusionDirector.1.0.ClusterNodeIPModifyNotFinished': {
        "Message": "The IP address is being modified.",
        "NumberOfArgs": 0,
        "Resolution": "Try again 5 minutes after the last modification."
    },
    'FusionDirector.1.0.LicenseNotAvailable': {
        "Message": "This function is unavailable because of license limitation.",
        "NumberOfArgs": 0,
        "Resolution": "Import a license file and try again."
    },
    'FusionDirector.1.0.ServerProfileNotMatch': {
        "Message": "The configuration model in the server profile does not match that of device.",
        "NumberOfArgs": 0,
        "Resolution": "Create a plan template that complies with the current device configuration."
    },
    'FusionDirector.1.0.ClusterInternalNetworksMismatch': {
        "Message": "The reserved private network segment of the node to be added does not match that of the cluster.",
        "NumberOfArgs": 0,
        "Resolution": "Restore the nodes or cluster nodes to be added to factory settings, and reconfigure the nodes. Check that the reserved private network segment of the nodes to be added matches that of the cluster, and add the nodes again. For details, see the help information."
    },
    'FusionDirector.1.0.AppConfigProxyAuthenticationErr': {
        "Message": "Failed to log in to the proxy server due to authentication failure.",
        "NumberOfArgs": 0,
        "Resolution": "Enter the correct username and password of the proxy server and try again."
    },
    'FusionDirector.1.0.BaseManagerIPPoolUnavailable': {
        "Message": "No available IP addresses in ENCLOSURE_ManagementIPPool.",
        "NumberOfArgs": 0,
        "Resolution": "Ensure that ENCLOSURE_ManagementIPPool has available IP addresses."
    },
    'FusionDirector.1.0.BaseServiceIPPoolUnavailable': {
        "Message": "No available IP addresses in ENCLOSURE_ServiceIPPool.",
        "NumberOfArgs": 0,
        "Resolution": "Ensure that ENCLOSURE_ServiceIPPool has available IP addresses."
    },
    'FusionDirector.1.0.VersionNotSupported': {
        "Message": "The %1 version %2 is not supported. The earliest version supported is %3.",
        "NumberOfArgs": 3,
        "Resolution": "Update the device and submit the request again."
    },
    'FusionDirector.1.0.PropertyValueInvalid': {
        "Message": "The value %1 of the %2 attribute is invalid.",
        "NumberOfArgs": 2,
        "Resolution": "Correct the request body and submit the request again."
    },
    'FusionDirector.1.0.PropertyConflict': {
        "Message": "The value %1 of the %2 attribute conflicts with the %3 attribute of the resource %4.",
        "NumberOfArgs": 4,
        "Resolution": "Ensure that the attribute of the request is valid and submit the request again."
    },
    'FusionDirector.1.0.ResourceNotEnough': {
        "Message": "Insufficient %1 resources.",
        "NumberOfArgs": 1,
        "Resolution": "Ensure that the resources are sufficient and submit the request again."
    },
    'FusionDirector.1.0.PropertyValueOutOfRange': {
        "Message": "The value %1 of the %2 attribute is out of the range %3.",
        "NumberOfArgs": 3,
        "Resolution": "Ensure that the attribute of the request is valid and submit the request again."
    },
    'FusionDirector.1.1.OperationNotSupportedOnState': {
        "Message": "The current status of resource %1 does not support this operation.",
        "NumberOfArgs": 1,
        "Resolution": "Wait until the object is in the proper state and try again."
    },
    "Base.1.4.ResourceExhaustion": {
        "Message": "The requested resource %1 is unavailable.",
        "NumberOfArgs": 1,
        "Resolution": "Check whether the resource is available and try again."
    },
    "iBMC.1.0.AuthorizationFailed": {
        "Message": "Authorization failed because the user name or password is incorrect, or your account is locked.",
        "NumberOfArgs": 0,
        "Resolution": "Try again using the correct user name and password, or after your account is unlocked."
    },
    "iBMC.1.0.IPv4AddressConflict": {
        "Message": "The IPv4 address does not match the gateway address or conflicts with an IPv4 address in another group.",
        "NumberOfArgs": 0,
        "Resolution": "Ensure that the IPv4 address matches the gateway address and differs from all IPv4 addresses in other groups."
    },
    "iBMC.1.0.ActionParameterValueInvalid": {
        "Message": "The value %1 for the action parameter %2 is invalid.",
        "NumberOfArgs": 2,
        "Resolution": "Try again using a valid parameter value."
    },
    'FusionDirector.1.0.CertCannotCreateChain': {
        "Message": "Failed to generate a valid certificate chain for a specific certificate because one or more certificates may not be added to the chain.",
        "NumberOfArgs": 0,
        "Resolution": "Check whether the required certificated are added to the system trusted storage and are valid."
    },
    'FusionDirector.1.0.PowerServerNotInSameRack': {
        "Message": "The servers specified by the parameter do not belong to the same rack.",
        "NumberOfArgs": 0,
        "Resolution": "Modify the parameter and submit the request again."
    },
    'FusionDirector.1.0.PowerRackCappingDisable': {
        "Message": "The power capping function is disabled in the rack where the server is located.",
        "NumberOfArgs": 0,
        "Resolution": "Enable the rack power capping function and submit the request again."
    },
    'FusionDirector.1.0.RackLocationConflict': {
    ...
    'FusionDirector.1.0.BackupCheckCPackageError': {
        "Message": "Failed to verify the backup package.",
        "NumberOfArgs": 0,
        "Resolution": "Check the format and integrity of the backup package, and upload it again."
    },
    'FusionDirector.1.0.UpgradeCheckCPackageError': {
