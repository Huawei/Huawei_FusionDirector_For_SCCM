var i18n_en = {
    ...
    FDConfig: {
        ...
        hostNull: 'IP Address or FQDN cannot be empty',
        ...
        hosturlError: 'Invalid address or domain',
        ...
        security_certificateFile: "Certificate",
        security_certificateIssuer: "Issued By",
        security_certificateSubject: "Used By",
        security_certificateNotBefore: "Valid From",
        security_certificateNotAfter: "Expire At",
        security_certificateAccount: 'Accepted',
        set: "Director setting",
    },
    config: {
        pleaseSelect: 'Please select ',
        templateName: 'Name',
        ...
        configurationModule_CheckIPOrDomainName: "Enter a valid IPv4 address、IPv6 address or FQDN.",
        ...
        configurationModule_clearUniqueKey: "Clear NIC Unique Key",
        ...
        "Max_Efficient": "MaxEfficient",
        "Max_Efficiency": "MaxEfficient",
        ...
        "IIO_Configuration": "IIO Configuration",
        "PCI_64Bit_Resource_Allocation": "PCI 64Bit Resource Allocation",
        simpleStart: 'Rely on: ',
        simpleAND: ' and ',
    ...
    alarmEvent: {
        alarmEvent_alarmAndEvent: "Alarms and Events",
        alarmEvent_alarmOrEventWord: "alarms or events",
        alarmEvent_serialNumber: "SN",
        alarmEvent_eventID: "Event ID",
        alarmEvent_eventSource: "Source",
        alarmEvent_eventSubject: "Event Subject",
        alarmEvent_deviceSN: "Device SN",
        alarmEvent_deviceType: "Device Type",
        alarmEvent_status: "Status",
        alarmEvent_description: "Description",
        alarmEvent_clearType: "Clear Type",
        alarmEvent_clearTime: "Clear Time",
        alarmEvent_clearCause: "Reason",
        alarmEvent_firstOccurTime: "First Occurred",
        alarmEvent_lastOccurTime: "Last Occurred",
        alarmEvent_occurCounts: "Number of Occurrences",
        alarmEvent_confirmStatus: "Acknowledge Status",
        alarmEvent_eventName: "Name",
        alarmEvent_severity: "Severity",
        alarmEvent_parts: "Component",
        alarmEvent_effect: "Impact",
        alarmEvent_handingSuggesstion: "Handling Suggestion",
        alarmEvent_possibleCause: "Possible Cause",
        alarmEvent_eventCategory: "Event Type",
        alarmEvent_currentAlarm: "Current Alarm",
        alarmEvent_historyAlarm: "Historical Alarm",
        alarmEvent_event: "Event",
        alarmEvent_lockRolling: "Start Refreshing",
        alarmEvent_unLockRolling: "Stop Refreshing",
        alarmEvent_clear: "Clear",
        alarmEvent_confirm: "Acknowledge",
        alarmEvent_clearWord: "clear",
        alarmEvent_unConfirm: "Unacknowledge",
        alarmEvent_customColumn: "Customized Column",
        alarmEvent_selectColumn: "Select Column",
        alarmEvent_category: "Type:",
        alarmEvent_all: "All",
        alarmEvent_selectAll: "Select All",
        alarmEvent_warning: "Warning",
        alarmEvent_critical: "Critical",
        alarmEvent_cleared: "Cleared",
        alarmEvent_unCleared: "Uncleared",
        alarmEvent_confirmed: "Acknowledged",
        alarmEvent_unConfirmed: "Unacknowledged",
        alarmEvent_lastOneDay: "Last Day",
        alarmEvent_lastSevenDay: "Last 7 Days",
        alarmEvent_lastOneMonth: "Last 30 Days",
        alarmEvent_reset: "Reset",
        alarmEvent_up: "Up",
        alarmEvent_down: "Down",
        alarmEvent_clearNoSelect: "Select one or more alarms to be cleared.",
        alarmEvent_clearSuccess: "Cleared successfully.",
        alarmEvent_exportSelected: "Export Selected",
        alarmEvent_exportAll: "Export All",
        alarmEvent_clearSelected: "Clear Selected",
        alarmEvent_clearAll: "Clear All",
        alarmEvent_clearNoAlarmTip: "There is no alarm to be cleared in the current list.",
        alarmEvent_clearAlarmTip: "Clear current alarms. The current alarms will be changed to historical alarms.",
        alarmEvent_confirmClearTip: "Are you sure you want to clear the alarms?",
        alarmEvent_clearMessageTip: "The selected historical alarms or events cannot be cleared. Are you sure you want to continue?",
        alarmEvent_noClearOptMessageTip: "Historical alarms or events cannot be cleared.",
        alarmEvent_eventSourceInvalid: "Invalid event source.",
        alarmEvent_advancedSearch: "Advanced Search",
        alarmEvent_unconfirmMessageTip: "A select event or an alert that has been reversed can not perform a counter confirmation operation to confirm ?",
        alarmEvent_confirmMessageTip: "Select an event or an alert that has been confirmed cannot confirm the operation, confirm whether to continue?",
        alarmEvent_confirmNoAlarmTip: "There is no pending alarm for the current list!",
        alarmEvent_unconfirmNoAlarmTip: "The current list has no pending confirmation of the alarm!",
        alarmEvent_confirmSelected: "Acknowledge Selected",
        alarmEvent_confirmAll: "Acknowledge All",
        alarmEvent_unconfirmSelected: "Unacknowledge Selected",
        alarmEvent_unconfirmAll: "Unacknowledge All",
        alarmEvent_markAsRead: "Mark as Read",
        alarmEvent_markAsUnread: "Mark as Unread",
        alarmEvent_markAsReadSelected: "Mark Selected as Read",
        alarmEvent_markAsReadAll: "Mark All as Read",
        alarmEvent_markAsUnreadSelected: "Mark Selected as Unread",
        alarmEvent_markAsUnreadAll: "Mark All as Unread",
        alarmEvent_markAsReadConfirmTip: "Do you want to confirm that you marked as read?",
        alarmEvent_markAsUnreadConfirmTip: "Do you want to confirm that you marked the unread operation?",
        alarmEvent_markAsReadAlarmTip: "After the tag, the alert or event becomes read state",
        alarmEvent_markAsUnreadAlarmTip: "After the tag, the alert or event will become unread",
        alarmEvent_markAsReadMessageTip: "The selected alarm or event has been read to confirm whether to continue?",
        alarmEvent_markAsUnreadMessageTip: "The selected alarm or event has unread, confirm whether to continue?",
        alarmEvent_markAsReadNoSelect: "Please select one or more alarms or events to mark as read!",
        alarmEvent_markAsUnreadNoSelect: "Please select one or more alarms or events to mark as unread!",
        alarmEvent_markAsReadNoChooseSelect: "You have chosen no alarms or events to mark as read!",
        alarmEvent_markAsUnreadNoChooseSelect: "You have chosen no alarms or events to mark as unread!",
        alarmEvent_markAsReadSuccess: "Mark as read successful!",
        alarmEvent_markAsUnreadSuccess: "Mark as unread success!",
        alarmEvent_markAsReadNoAlarmTip: "The current list has no unread alarms or events!",
        alarmEvent_markAsUnreadNoAlarmTip: "The current list has no read alarms or events!",
        alarmEvent_markAsReadOrUnread: "Read and unread",
        alarmEvent_CombiningSort: "Sort",
        alarmEvent_ASC: "Ascending",
        alarmEvent_DESC: "Descending",
        alarmEvent_firstSort: "First Sort Field",
        alarmEvent_secondSort: "Second Sort Field",
        alarmEvent_thirdSort: "Third Sort Field",
        alarmEvent_refresh: "Refresh",
        alarmEvent_normal: "OK",
        alarmEvent_unClear: "Undo Clear",
        alarmEvent_unClearSuccess: "Undid clearing successfully.",
        alarmEvent_confirmUnclearTip: "Are you sure you want to undo clearing of the alarms?",
        alarmEvent_unclearAlarmTip: "Undo clearing historical alarms. The historical alarms will be changed to current alarms.",
        alarmEvent_unclearCause: "Reason",
        alarmEvent_clearCausePlaceholder: "Enter the reason (0 to 150 characters).",
        alarmEvent_unclearCausePlaceholder: "Enter the reason (0 to 150 characters).",
        alarmEvent_clearCauseTextareaTip: "You can enter a maximum of 150 characters.",
        alarmEvent_unclearSelected: "Undo Selected",
        alarmEvent_unclearAll: "Undo All",
        alarmEvent_unclearNoAlarmTip: "There is no alarm to be cleared in the current list.",
        alarmEvent_unclearNoSelect: "Select one or more cleared alarms to undo clear.",
        alarmEvent_noUnclearOptMessageTip: "The cleared alarms, events, or the historical events that are automatically cleared cannot be restored.",
        alarmEvent_unclearMessageTip: "The cleared alarms, events, or the historical events that are automatically cleared cannot be restored. Do you want to continue?",
        alarmEvent_confirmCause: "Reason",
        alarmEvent_unconfirmCause: "Reason",
        alarmEvent_confirmConfirmTip: "Are you sure you want to acknowledge the alarms?",
        alarmEvent_confirmUnconfirmTip: "Are you sure you want to unacknowledge the alarms?",
        alarmEvent_confirmAlarmTip: "The acknowledged alarms or events will change to the Acknowledged state.",
        alarmEvent_unconfirmAlarmTip: "The unacknowledged alarms or events will change to the unacknowledged state.",
        alarmEvent_confirmCausePlaceholder: "Enter the reason (0 to 150 characters).",
        alarmEvent_unconfirmCausePlaceholder: "Enter the reason (0 to 150 characters).",
        alarmEvent_confirmSuccess: "Acknowledgement successful.",
        alarmEvent_unconfirmSuccess: "Unacknowledgement successful.",
        alarmEvent_confirmNoSelect: "Select one or more alarms to be acknowledged.",
        alarmEvent_unconfirmNoSelect: "Select one or more alarms to be unacknowledged.",
        alarmEvent_confirmNoChooseSelect: "The alarms you selected do not need to be acknowledged.",
        alarmEvent_unconfirmNoChooseSelect: "The alarms you selected do not need to be unacknowledged.",
        alarmEvent_clearOrNoDoUser: "Cleared/Undid Clear By",
        alarmEvent_clearOrNoDoTime: "Cleared/Undid Clear At",
        alarmEvent_clearOrNoDoCause: "Reason for Clear/Undo Clear",
        alarmEvent_confirmOrNoDoUser: "Acknowledged/Unacknowledged By",
        alarmEvent_confirmOrNoDoTime: "Acknowledged/Unacknowledged At",
        alarmEvent_confirmOrNoDoCause: "Reason for Acknowledgement/Unacknowledgement",
        alarmEvent_manualClear: "Manual Clear",
        alarmEvent_normalClear: "NormalClear",
        /*新增词条*/
        alarmEvent_shielding: "Mask",
        alarmEvent_shieldingAll: "Mask All",
        alarmEvent_shieldingSelected: "Mask Selected",
        alarmEvent_removeShielding: "Unmask",
        alarmEvent_removeShieldingAll: "Unmask All",
        alarmEvent_removeShieldingSelected: "Unmask Selected",
        alarmEvent_shieldedAlarmEvent: "Masked Alarms and Events",
        alarmEvent_shieldedAlarmEventSuccess: "Masked alarms and events successfully.",
        alarmEvent_removeShieldedAlarmEventSuccess: "Unmasked alarms and events successfully.",
        alarmEvent_shieldNoAlarmTip: "No alarm or event that can be masked exists in the current list.",
        alarmEvent_unShieldNoAlarmTip: "No alarm or event that can be unmasked exists in the current list.",
        alarmEvent_shieldConfirmTip: "Are you sure you want to mask the alarms and events?",
        alarmEvent_unShieldConfirmTip: "Are you sure you want to unmask the alarms and events?",
        alarmEvent_shieldAlarmTip: "The alarms and events will be masked.",
        alarmEvent_unShieldAlarmTip: "The alarms and events will be unmasked.",
        alarmEvent_shieldNoChooseSelect: "The alarms and events are already masked.",
        alarmEvent_unShieldNoChooseSelect: "The alarms and events are not masked.",
        alarmEvent_shieldNoSelect: "Select one or more alarms and events to be masked.",
        alarmEvent_unShieldNoSelect: "Select one or more alarms and events to be unmasked.",
        alarmEvent_shieldMessageTip: "Some of the alarms or events are already masked. Are you sure you want to continue?",
        alarmEvent_unShieldMessageTip: "Some of the alarms or events are not masked. Are you sure you want to continue?",
        alarmEvent_moreOperation: "More",
        alarmEvent_viewMore: "Show",

        alarmEvent_customDays: "Custom",
        alarmEvent_moreFilt: "More Filtering",

        alarmEvent_saveTemplate: "Save Template",
        alarmEvent_saveTemplateType: "Saved to",
        alarmEvent_saveToOldTemplate: "Existing template",
        alarmEvent_saveToNewTemplate: "New template",
        alarmEvent_saveTemplateName: "Name",
        alarmEvent_saveTemplateInputName: "Enter a name.",
        alarmEvent_saveTemplateInputNameTip: "The name is invalid.",
        alarmEvent_saveTemplateInputNameLengthTip: "The name can contain a maximum of 32 characters.",

        alarmEvent_noDeviceID: "No valid device ID is obtained.",
        alarmEvent_noFrameManagementInfo: "Failed to obtain the chassis information.",
        alarmEvent_noFrameManagementToInfo: "Failed to obtain the chassis information.",
        alarmEvent_getFrameManagementInfoFail: "Failed to obtain the chassis information.",
        alarmEvent_inputEventName: "Enter an event name",
        alarmEvent_inputEventSource: "Enter an event source",
        alarmEvent_inputDeviceType: "Enter a device type",
        alarmEvent_inputEventCategory: "Enter an event type",
        alarmEvent_selectTemplate: "Select a template...",
        alarmEvent_selectTemplateToDelete: "Select the template to be deleted...",

        alarmEvent_shieldConfirmAllTip: "Are you sure you want to mask all the alarms and events?",
        alarmEvent_unShieldConfirmAllTip: "Are you sure you want to unmask all the alarms and events?",
        alarmEvent_markAsReadConfirmAllTip: "Are you sure you want to mark all the alarms as read?",
        alarmEvent_markAsUnreadConfirmAllTip: "Are you sure you want to mark all the alarms as unread?",
        alarmEvent_confirmConfirmAllTip: "Are you sure you want to acknowledge all the alarms?",
        alarmEvent_confirmUnconfirmAllTip: "Are you sure you want to unacknowledge all the alarms?",
        alarmEvent_confirmClearAllTip: "Are you sure you want to clear all the alarms?",
        alarmEvent_confirmUnclearAllTip: "Are you sure you want to undo clearing of all the alarms?",
        alarmEvent_openAlarmDetailTip: "Viewing alarm details will stop the automatic refresh operation. Are you sure you want to continue?"
    },
    upgradePackage: {
    ...
    imageManage: {
        ...
        imageManage_imageTypeColon: "Image Type",
        imageManage_imageVersionColon: "Image Version",
        imageManage_imageFilleTypeColon: "File System",
        imageManage_imageSizeColon: "Size",
        imageManage_imageStatusColon: "Status",
        imageManage_imageFileOwnerColon: "Image File Owner",
        imageManage_imageFileNameColon: "Image File Name",
        imageManage_imageVisibilityColon: "Image Visibility",
        imageManage_imageFileDescriptionColon: "Image Description",
        imageManage_selsctImageFileColon: "Image File",
        imageManage_checkOperationColon: "Verification Operation",
        ...
        imageManage_noCheck: "Not check",
        imageManage_fileNameRepeat: "Duplicate file name.",
        //imageManage_checkCodeError: "Enter uppercase letters, lowercase letters, or digits.",
        imageManage_pleaseSelectImageType: "Please select an image type.",
        imageManage_pleaseSelectImageVersion: "Please select an image version.",
        imageManage_pleaseSelectImageFileType: "Please select an image type.",
        imageManage_pleaseSelectCheckImageType: "Please select an image verification mode.",
        ...
        imageManage_fileTypeError: "Invalid format. Upload another file.",
        imageManage_deleteMessage: "Deleting an image will delete the associated deployment template. Exercise caution when deleting an image.",
        imageManage_IPPoolName: "IP Pool For SP Network",
        imageManage_Usage: "Use Rate",
        imageManage_ldapSwitchTip: "Before cloning an image, ensure that the network is normal, the FusionDirector and in-band system are connected, and the IP address segment of the resource pool is connected to the SP.",

        imageManage_ldapSwitchTip1: "Before deploying a device, ensure that the network is normal, the FusionDirector and in-band system are connected, and the IP address segment of the resource pool is connected to the SP.",
        imageManage_supportType: "The OS clone image supports only SLES 12.2, RHEL, and CentOS 7.4.",
        imageManage_chooseDevice: "Select Device",
        imageManage_ipPool: "IP Resource Pool",
        imageManage_imageManageIPPoolsTips: "Ensure that IP addresses are sufficient. Generally, a clone image requires an IP address.",
        imageManage_IPPoolvalue: "{2} IP addresses are available in the {1} resource pool.",
        imageManage_osNumber: "Images",
        imageManage_imageOsType: "OS",
        imageManage_maxSize: "The image file size cannot exceed 15 GB. Please upload again.",
        imageManage_IEmaxSize: "The file size exceeds the upper limit (4 GB) of the browse. To upload a larger file, use Firefox or Chrome.",
        imageManage_fileNameTip: "The image file name can contain only letters, digits, spaces, and special characters -_.&().",
        imageManage_imageVersion: "Image Version",
        imageManage_generalView: "Images",
        imageManage_memorySpace: "Image Space (MB)",
        imageManage_usedOS: "Used/Total",
        OSDeploy_createDeployModel: "Create Deployment Template",
        imageManage_snmpMD5TextTip: 'MD5 may cause security risks. You are advised to select SHA256.',
    },
    OSDeploy: {
        deploy_name1: "Deploy",
        ...
        OSDeploy_modelName: "Template Name",
        OSDeploy_networkSet: "Network Settings",
        OSDeploy_hostNamePrefix: "Hostname Prefix",
        OSDeploy_IPType: "IP Address Type",
        OSDeploy_networkStart: "Start Network Segment",
        OSDeploy_networkEnd: "End Network Segment",
        OSDeploy_networkMask: "Subnet Mask",
        ...
        OSDeploy_errorMask: "Invalid subnet mask.",
        //新增
        OSDeploy_wrongCDKey: "Enter a correct CD Key number.",
        OSDeploy_noCDkeyTip: "If no CD Key number is configured, the installation may fail. Are you sure you want to continue?",
        OSDeploy_errorCPname: "Enter uppercase letters, lowercase letters, digits,and hyphens (-).",
        OSDeploy_errorDiskSize: "The value must be greater than or equal to 32 GB and must be an integer.",
        OSDeploy_errorPasswordLength: "The password must contain more than six characters.",
        OSDeploy_errorPwordLength: "The password must contain more than seven characters.",
        OSDeploy_errorPasswordLinux: "The password must contain at least six characters and cannot contain space, #, and $.",
        OSDeploy_BMCIP: "IP Address",
        OSDeploy_SN: "Device SN",
        OSDeploy_whetherToSynchronizeData: "Configuration Synchronization",

        OSDeploy_Group: "Group",
        OSDeploy_inputIPTip: "Enter an IP address",
        OSDeploy_inputModelTip: "Enter a type",
        OSDeploy_selectGroup: "Select a group",
        OSDeploy_mold: "Type",
        OSDeploy_systemCapacity: "Capacity (GB)",
        OSDeploy_rootPartitionTip: "Define a disk as the system disk. The system disk capacity can be customized.",
        OSDeploy_rootWindowsPartitionTip: " The system disk capacity can be customized.",
        OSDeploy_rootPartitionTip1: "The earliest version supported by Smart Provisioning is 1.16.",
        OSDeploy_rootPartition: "Partition",
        OSDeploy_addRootPartitionTip: "Add Partitions",
        OSDeploy_fenhao: ';',
        OSDeploy_swapPartition: "Swap Partition",
        OSDeploy_swapPartTip: "The capacity must be greater than 1 GB and must be an integer.",
        OSDeploy_rootPartTip: "The capacity must be greater than 10 GB and must be an integer.",
        OSDeploy_PartTip: "The capacity must be greater than 1 GB and must be an integer.",
        OSDeploy_rootPartName: "The name starts with a slash (/) and cannot contain <>|:& or spaces.",
        OSDeploy_rootPartNametip: "The name cannot contain two consecutive slashes (/).",
        OSDeploy_rootPartRepeatName: "The root partition name must be unique.",
        OSDeploy_partInfo: "Partition Information",
        OSDeploy_View: "View",
        OSDeploy_SPVersion: "SP Version",
        OSDeploy_supportedSPVersion: "Earliest SP Version Supported",
        OSDeploy_deviceTip: "For details about the operating system installation and server software/hardware(boot type, RAID card model...) compatibility, see the Smart Provisioning User Guide.",
        OSDeploy_osVersionInfo: "The version in the image information must be the same as the actual image file version.",
        OSDeploy_languageTip: "The selected language must be a language supported the OS image.",
        OSDeploy_iBMALable: "iBMA",
        OSDeploy_install: "Install",
        OSDeploy_installTip: "If you deselect this option, you need to manually install the iBMA. Without the iBMA, the OS driver cannot be upgraded.",
        OSDeploy_createModel: "Create Image Template",
        OSDeploy_createOSDeployModel: "Create Deployment Template",
        OSDeploy_OSDeploy: "Deploy OS",
        OSDeploy_selectModel: "Please select the device model",
        OSDeploy_alreadySelect: "Selected (PCS)",
        OSDeploy_deviceDeploy: "Device Deployment",
        OSDeploy_selectDeployModel: "Select Deployment Template",
        OSDeploy_selectDevice: "Select Device",
        OSDeploy_startDeploy: "Start Deployment",
        OSDeploy_start: "Start",
        OSDeploy_deployHasStart: "The device deployment template is successfully created.",
        OSDeploy_skipCount: "After {1}, the system automatically switches to the OS Deployment Template List.",
        OSDeploy_osList: "OS Deployment Template List",
        OSDeploy_click: "Click",
        OSDeploy_restartDeploy: " and select a new template to create a deployment task.",
        OSDeploy_taskSate: "Task Status",
        OSDeploy_taskSateTip: " to view the task progress.",
        OSDeploy_selectDeviceTip: 'Add information about the device to be deployed and click Add Now to add the device online.',
        OSDeploy_addDeviceBtn: 'Add Now',
        OSDeploy_deviceNumber: 'Number of Devices(PCS)',
        OSDeploy_infoTip: "Before the operation, download the image file of the correct version from its official OS website.If the OS version is incorrect, subsequent deployment will fail.",
        OSDeploy_addDeviceTip: 'Check whether the operating system has been installed on the selected device. If the operating system has been installed on the selected device, the system disk data will be deleted and the operating system will be reinstalled. Store the data properly.', //待翻译,
        OSDeploy_manageStatus: "Management Status",
        OSDeploy_errorPasswordUbuntu: "The password must contain at least eight characters and cannot contain space, #, and $.",
        OSDeploy_deployVmVal: 'The value include 7 to 40 characters and must contain at least three types of the following characters: letters, digits,and special characters ` ~!@#$%^&*()-_=+\\|[{}]: \'",<.>/?.',

        deploy_deploy: "Deploy",
        deploy_name: "Intelligent Configuration and Deployment",
        deploy_OSDeploy: "OS Deployment",
        deploy_imageModel: "Deployment Template",
        deploy_imageModelWord: "deployment templates",
        //列表:
        deploy_status: "Status",
        deploy_createTime: "Created",
        deploy_updateTime: "Updated At",
        deploy_description: "Deployment Template Description",
        //详情:
        deploy_detail: "Details",
        ...
        deploy_installInfo: "Installation Information",
        deploy_statusColon: "Status",
     /*    deploy_createTimeColon: "Created",
        deploy_updateTimeColon: "Updated At",
        deploy_descriptionColon: "Description", */
        deploy_installCDKey: "CDKey of the OS to Be Installed",
        deploy_installHostName: "Hostname of the OS to Be Installed",
        deploy_installPlacePartition: "Installation Position Partition Mode",
        deploy_OSLanguage: "OS Operation Language",
        deploy_keyBoard: "Keyboard Option",
        deploy_installOption: "Installation Option",
        deploy_timeZone: "Time Zone",
        deploy_passwordConfirmedAgain: "Confirm Password",
        deploy_descriptionLimit: "The description cannot exceed 256 characters.",
        deploy_selectImage: "Select Image",
        deploy_addDevice: "Add New Device",
        deploy_autoPartition: "Automatic Partition",
        deploy_definedPartition: "Customize Partition",
        deploy_selectDevice: "Select Device",
        deploy_selectAll: "Select All",
        ...
        deploy_pleaseInputKeywords: "Type to Search",
        deploy_enterSearchContent: "Type keywords to search.",
        deploy_nameBytesLimit: "The name cannot exceed 5 bytes.",
        deploy_unavailable: "Unavailable",
        deploy_available: "Available",
        deploy_using: "In use",
        deploy_initial: "Initialize",
        ...
        deploy_standard: "Standard",
        //新增
        deploy_cpFirstNameLinux: "Hostname",
        deploy_cpFirstNameWin: "Computer Name Prefix",
        deploy_cpFirstNameWinExplain: "If this parameter is left blank, the last 15 characters of the SN are used by default.",
        deploy_cpFNWinExplain: "Prefix + Last ten characters of the SN",
        deploy_example: "Example: ",
        ...
        deploy_vmDefault: "Default",
        deploy_notEmpty: "The name cannot contain only spaces.",
        deploy_baseInfo: "Basic Information",
        deploy_osInfo: "Image Information",
        deploy_online: "Online",
        OSDeploy_status: "Status",
        deploy_imageType: "Image Type",
        deploy_imageManage: "OS Image Template",
        deploy_imageFileName: "Image Template Name",
        deploy_ready: "Ready",
        valid_maxSize_info: 'Enter a maximum of 8 characters.'
    },
    quickupgrade: {
    ...
    setting: {
        basicSetting: 'vCenter setting',
        pageTips: 'Please configure vCenter setting first',
        userName: 'vCenter User Name',
        password: 'vCenter Password',
        hostIp: 'vCenter IP',
        port: 'Port',
        portTips: 'Need to be configured as same as the port of https configured when the vCenter installing(default is 443).',
        ...
        vCenterTips: "Description：Plugin use this account to connect to the vCenter Server",
        fqdn: 'vCenter FQDN',
        hosturlNull: 'FQDN cannot be empty'
    },
    upgradePackageWarehouse: {
        ...
        versionWarehouse_usedState: "Status",
        ...
        versionWarehouse_upgradeName: "Update Package Name",
        ...
        versionWarehouse_downLoadTip: "Download the update package and digital signature certificate from HOUP and upload them to FusionDirector. The size of each uploaded file must be less than 10 GB.",
        ...
        versionWarehouse_urlRule: "The value starts with https/http and consists of digits, letters, and special characters (-_:/.?%&=). The value must end with only a digit, letter, or /. The value can contain 12 to 512 characters.",
        ...
        versionWarehouse_SearchTip: "Type to Search",
        versionWarehouse_manufacturer: "Vendor",
        versionWarehouse_component: "Component",
        versionWarehouse_model: "Model",
        versionWarehouse_packagesNumber: "Number of Update Packages",

        versionWarehouse_onlineAddress: "Source",
        versionWarehouse_houpConnection: "HOUP Connection ",
        versionWarehouse_storgeSpace: "Storage Capacity ",
        versionWarehouse_customBaselineBtn: "Create Baseline",
        versionWarehouse_importExitBaseline: "Import Baseline",
        versionWarehouse_addUpgradePackage: "Select Update Package",
        versionWarehouse_name: "Name",
        //手动添加的
    ...
    deviceVersionStatus: {
        ...
        deviceVersionStatus_OSVersion: "OS",
        deviceVersionStatus_Select_OSVersion: "OS version",
        deviceVersionStatus_UnableToObtain: "N/A",
        deviceVersionStatus_UnableToObtainTip: "The OS version can be displayed only after iBMA 2.0 is installed and started.",
        deviceVersionStatus_NoUpgrade: "No update schedule",
        deviceVersionStatus_ToUpgrade: "To be updated",
        deviceVersionStatus_UpgradeFail: "Update failed",
        ...
        deviceVersionStatus_Actived: "Taken effect",
        deviceVersionStatus_PartialActiveSuccess: "Partially taken effect",
        deviceVersionStatus_healthStatus: "Health",
        deviceVersionStatus_OK: "Normal",
        deviceVersionStatus_Warning: "Warning",
        deviceVersionStatus_Critical: "Critical",
        deviceVersionStatus_unknown: "Unknown",
        ...
        deviceVersionStatus_status: "Update Status",
        deviceVersionStatus_productType: "Model",
        deviceVersionStatus_plan: "Update Schedule",
        deviceVersionStatus_deleteMoreErrorTip: "Select one or more devices that can take effect.",
        deviceVersionStatus_firmwareType: "Component Type",
        deviceVersionStatus_availableVersion: "Available Version",
        deviceVersionStatus_availableVersionTip: "To update to an available version, go to the intelligent version management page.",
        deviceVersionStatus_manufacturer: "Vendor",
        deviceVersionStatus_type: "Type",
        deviceVersionStatus_component: "Component",
        deviceVersionStatus_powerStatus: "Power Status",
        deviceVersionStatus_powerOn: "Power On",
        deviceVersionStatus_powerOff: "Power Off",
        deviceVersionStatus_Address: "Address",

        deviceVersionStatus_currentVersion: "Current Version",
        deviceVersionStatus_targetVersion: "Target Version",
        deviceVersionStatus_currentDriverVersion: "Current Version",
        deviceVersionStatus_targetDriverVersion: "Target Version",
    },
    upgradePlan: {
        ...
        /**************************************2019-07-15 ****************************************/
        upgradePlan_planName: "Name",
        upgradePlan_status: "Status",
        upgradePlan_end: "Disable",
        upgradePlan_description: "Description",
        upgradePlan_creatUpgradePlan: "Create Schedule",
        upgradePlan_updateDate: "Update Time",
        upgradePlan_createDate: "Created On",
        upgradePlan_refreshDate: "Updated On",
        upgradePlan_selectDeviceGroup: "Select Group",
        upgradePlan_check: "Check",
        upgradePlan_planPolicy: "Policy",
        upgradePlan_targetDevice: "Target Device",
        upgradePlan_address: "Address",
        upgradePlan_Model: "Model",
        upgradePlan_OSVersion: "OS Version",
        upgradePlan_type: "Type",
        upgradePlan_systemGroup: "Device Group",
        upgradePlan_device: "Device",
        upgradePlan_allGroup: "All Groups",
        upgradePlan_server: "Server",
        upgradePlan_OK: "Normal",
        upgradePlan_Warning: "Warning",
        upgradePlan_Critical: "Critical",
        upgradePlan_unknown: "Unknown",
        upgradePlan_nullPackageTip: "If no version is available, go to the Update Package Repository page to create a baseline or upload an update package.",
        upgradePlan_packageRestiy: "Update Package Repository",
        upgradePlan_targetVersion: "Target Version",
        upgradePlan_packageCounts: "Number of Update packages",
        upgradePlan_baselineName: "Baseline Name",
        upgradePlan_packageName: "Name",
        upgradePlan_Address: "Address",
        upgradePlan_component: "Component",
        upgradePlan_manufacturer: "Vendor",
        upgradePlan_size: "Size",
        upgradePlan_huaweiBaseline: "Huawei baseline",
        upgradePlan_customBaseline: "Customized baseline",
        upgradePlan_bundleFirmware: "Firmware Combination Package",
        upgradePlan_bundleSoftware: "Software Combination Package",
        upgradePlan_bundleDirve: "Drive Combination Package",
        upgradePlan_packageFirmware: "Firmware package",
        upgradePlan_packageSoftware: "Software Package",
        upgradePlan_packageDirve: "Drive package",
        upgradePlan_powerStatus: "Power Status",
        upgradePlan_checkReportTip: "Generating the check report … Please wait.",
        upgradePlan_progress: "Progress",
        upgradePlan_checkDevice: "Check the versions of devices and components to determine whether they need to be updated.",
        upgradePlan_sameVersionComponent: "The component version is the same as the target version. The update will not be performed this time.",
        upgradePlan_noUpgradePackageComponent: "The component does not have the matching update package and cannot be updated.",
        upgradePlan_noOSInfoComponent: "Failed to obtain complete component information. Check whether the iBMA is properly deployed and started.",
        upgradePlan_noMatchingComponent: "The component version does not match the driver version. Forcible update may cause version incompatibility. Services may be affected after the update.",
        upgradePlan_noMatchingDrive: "After the update, some board drivers and firmware versions are incompatible. Services may be affected after the update.",
        upgradePlan_canUpgradeDrive: "If an associated board component is available, the automatic update of the associated board component will be started.",
        upgradePlan_noUpgradeDrive: "If an associated board component is available, the automatic update of the associated board component will be canceled.",
        upgradePlan_upgradePolicy: "Scheduled Start Policy",
        upgradePlan_batchPolicy: "Device Batch Policy",
        upgradePlan_quickUpgrade: "now",
        upgradePlan_occer: "Scheduled Effective Period",
        upgradePlan_week: "Weekly",
        upgradePlan_month: "Monthly",
        upgradePlan_specifiedTime: "Specified time",
        upgradePlan_weekly: "Day of Week",
        upgradePlan_time: "Time",
        upgradePlan_one: "Monday",
        upgradePlan_two: "Tuesday",
        upgradePlan_three: "Wednesday",
        upgradePlan_four: "Thursday",
        upgradePlan_five: "Friday",
        upgradePlan_six: "Saturday",
        upgradePlan_seven: "Sunday",
        upgradePlan_date: "Date",
        upgradePlan_dateTime: "Time",
        upgradePlan_effectPolicy: "Version Effective Policy",
        upgradePlan_batchPolicyTip: "Add and edit update queues based on service scenarios. Update tasks are executed in sequence.",
        upgradePlan_start: "Enable",
        upgradePlan_severity: "Severity",
        upgradePlan_critical: "Critical",
        upgradePlan_normal: "Normal",
        upgradePlan_unkown: "Unknown",
        upgradePlan_yes: "Yes",
        upgradePlan_no: "No",
        upgradePlan_noneDeviceTwo: "The monthly and weekly update configurations are enabled, and the batch function is unavailable.",
        upgradePlan_noneDeviceThree: "The batch update function is enabled. The monthly and weekly update configurations are unavailable.",
        upgradePlan_periodWeek: "The week cannot be empty when you set the update configuration check on a weekly basis.",
        upgradePlan_aupgradeReport: "Update Report",
        upgradePlan_noActive: "The component is to take effect and cannot be updated.",
        upgradePlan_activing: "The component takes effect and cannot be updated.",
        upgradePlan_upgrading: "The component is being upgraded and cannot be updated.",
        upgradePlan_model: "Model",
        upgradePlan_monthDate: ['1st', '2nd', '3rd', '4th', '5th', '6th', '7th', '8th', '9th', '10th', '11th', '12th', '13th', '14th', '15th', '16th', '17th', '18th', '19th', '20th', '21st', '22nd', '23rd', '24th', '25th', '26th', '27th', '28th', '29th', '30th', '31st'],
        upgradePlan_monthOverDayTip: "If the date does not exist in a month, the upgrade plan will not be executed this month.",
        upgradePlan_deviceGroup: "Device group",
        upgradePlan_pleaseSelectDevice: "Select the device to be updated in the following list. (If the device in the current list cannot be updated, try to replace the selected update package.)",
        upgradePlan_periodWeekTipOne: "on {0} in a week",
        upgradePlan_periodmonthTipOne: "on the {0} day in a month",
        upgradePlan_weekDate: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'],
        upgradePlan_serverBMCTip: "In the device group, only devices that have been successfully managed by FusionDirector are displayed in the list, and blade servers have been filtered out.",
        upgradePlan_upgradeTime: "Update Time",
        upgradePlan_slot: "Slot",
        upgradePlan_management: "Management Module",
        upgradePlan_switch: "Switch Module",
        upgradePlan_fanOrOther: "Fan Module and Others",
        upgradePlan_slotNum: "Slot",
        upgradePlan_deviceType: "Device Type",
        upgradePlan_deviceName: "Device Name",
        upgradePlan_SearchTip: "Please enter a keyword.",
        upgradePlan_Select_OSVersion: "OS version",
        upgradePlan_UnableToObtainTip: "The OS version can be displayed only after iBMA 2.0 is installed and started.",
        upgradePlan_healthStatus: "Health",
        upgradePlan_alreadyFinish: "Complete",
        upgradePlan_alreadyStart: "Enabled",
        upgradePlan_notStart: "Disabled",
        upgradePlan_immediateExecution: "Execute Immediately",
        upgradePlan_cycleCheck: "Periodical check",
        upgradePlan_information: "Basic Information",
        upgradePlan_selectVersion: "Select Version",
        upgradePlan_selectDevice: "Select Device",
        ...
        upgradePlan_nextStep: "Next",
        upgradePlan_upStep: "Previous",
        upgradePlan_selectBaseline: "Select Baseline",
        upgradePlan_baseline: "Baseline",
        upgradePlan_upgradePackage: "Update Package",
        upgradePlan_select: "Select",
        upgradePlan_selectUpgradePackage: "Select Update Package",
        upgradePlan_name: "Component Name",
        upgradePlan_version: "Version",
        upgradePlan_deviceTableList: "Device List",
        upgradePlan_groupName: "Name",
        upgradePlan_deviceCounts: "Device Quantity",
        upgradePlan_serialNumber: "SN",
        upgradePlan_group: "Group",
        upgradePlan_addDevicces: "Add New Device",
        upgradePlan_plan: "Schedule",
        upgradePlan_timeDelay: "Time Interval",
        upgradePlan_addBatches: "Add Update Queue",
        upgradePlan_teamName: "Queue Name",
        upgradePlan_delayTime: "Next Update Delay (Hour)",
        upgradePlan_deviceSelectTwo: "Select Device",
        ...
        upgradePlan_upgradeDeviceTeam: "Number of Update Queues",
        upgradePlan_startUpgrade: "Start Update",
        upgradePlan_confirmStartUpgradePlan: "Are you sure you want to enable the schedule {0}?",
        upgradePlan_confirmCloseUpgradePlan: "Are you sure you want to disable the schedule {0}?",
        upgradePlan_startSuccess: "Enabled successfully.",
        upgradePlan_closeSuccess: "Disabled successfully.",
        upgradePlan_differenceTip: "The update time ({0}) must be 1 minute later than the current time. Set update time again.",
        upgradePlan_nameRepeatTip: "The update schedule name already exists. Enter another one.",
        upgradePlan_nameRepeatCheck: "Failed to verify the update schedule name.",
        upgradePlan_descriptionRange: "The description can contain a maximum of 256 characters.",
        upgradePlan_activeEffectTip: "After the update is complete, the system automatically restarts for the update to take effect. Services may be interrupted during the restart. Are you sure you want to continue?",
        upgradePlan_addImportDeviceTip: "The batch update function is enabled. At least two batches of devices must be added, and a maximum of 10 batches can be added. The number of devices in each batch cannot be 0.",
        upgradePlan_groupSelectTip: "Select Group",
        upgradePlan_upgradeTip: "Batch Update",
        upgradePlan_descriptionTip: "Description",
        upgradePlan_groupSelectTitle: "Select Group",
        ...
        upgradePlan_usedPlan: "It has been used by another update schedule.",
        upgradePlan_noneDevice: "No devices available for update. The batch update function is unavailable.",
        upgradePlan_periodTip: "The batch update function has been enabled. The monthly and weekly update configurations are unavailable.",
        upgradePlan_notPeriodTip: "No device needs to be updated. The update check function can be configured only on a monthly or weekly basis.",
        upgradePlan_activeImedEffectTip: "The update schedule that is performed immediately cannot be paused. After the update is complete, the device automatically restarts for the update to take effect, which may interrupt services. Are you sure you want to continue?",
        upgradePlan_ImedAfterEffectTip: "The update schedule that is performed immediately cannot be paused. Are you sure you want to continue?",
        upgradePlan_upgradePlanScopeTip: "If you cannot perform the operation, contact the super administrator to check whether you have the operation permission on all devices in the update schedule.",
        upgradePlan_nullGroup: "Ungrouped",
        upgradePlan_SPVersion: "SmartProvisioning Version",
        upgradePlan_viewingATask: "View Task",
        upgradePlan_updatedSuc: "Updated successfully.",
        upgradePlan_currentVersion: "Current Version",
        upgradePlan_firmwareType: "Component Type",
        upgradePlan_checkTipTwo: "Are you sure you want to perform the update?",
        upgradePlan_managerTip: "Firmware update cannot be performed for only one management module because the firmware updates of the management modules are associated with each other.",
        upgradePlan_immediateEffectTipTwo: "The device restarts immediately after the update, which may result in service interruption. (Note: The BIOS and CPLD of a management module must be manually restarted for the update to take effect.)",
        upgradePlan_quickUpgradeText: "Start the update immediately after the update schedule is submitted.",
        upgradePlan_schduleUpgrade: "Execute later",
        upgradePlan_schduleUpgradeText: "Start the update at a specified date or time, including periodic update (only for selected devices and components) and single update.",
        upgradePlan_manualPolicy: "Take effect later",
        upgradePlan_manualPolicyText: "The setting takes effect immediately after the update or automatically takes effect upon the next startup of the device.",
        upgradePlan_autoPolicy: "Take effect immediately",
        upgradePlan_autoPolicyText: "The update takes effect immediately after the update. If the update takes effect after the update, services are interrupted.",
        upgradePlan_reboot: "Reboot required",
        upgradePlan_executionPolicy: "Execution Policy",
        upgradePlan_powerOn: "Power On",
        upgradePlan_powerOff: "Power Off",
        upgradePlan_UnableToObtain: "N/A",
        upgradePlan_powerNotSupport: "Update is not supported for a single PSU.",
        upgradePlan_powerTypeNot: "The update is not supported because of inconsistent PSU types on the device.",

        upgradePlan_powerStatusNot: "The update is not supported because the PSU has alarms.",
        upgradePlan_powerTypeOtherNot: "The update is not supported because of inconsistent PSU types on the device.",
        upgradePlan_powerTypeOtherError: "The update is not supported because other PSU on the device has alarms.",

        upgradePlan_fanTip: "Firmware update cannot be performed for only one fan module because the firmware updates of the fan modules are associated with each other.",
        upgradePlan_warnTipFirst: "Are you sure you want to start the update schedule {0} and make the update take effect immediately after the update task is complete?",
        upgradePlan_warnTipThree: "Are you sure you want to start the update schedule {0} and make the update take effect manually after the update task is complete or take effect automatically upon the next startup?",
        upgradePlan_warnTipFour: "Perform the update schedule {0} and make the update take effect manually after the update task is complete or automatically upon the next startup of the device",
        upgradePlan_warnTipFive: "Perform the update schedule {0} and make the update take effect immediately after the update task is complete",

        upgradePlan_managerWarnTip: "The BIOS and CPLD of a management module must be manually restarted for the update to take effect.",
        upgradePlan_backUpBMCComponent: "If the BMC versions in the active and standby areas are different from the target version, only the BMC in the active area is updated. If the BMC in the standby area needs to be updated, create another update schedule.",
        upgradePlan_diskRelationRaidNotMatch: "The update package does not match the RAID card model of the hard disk and cannot be updated.", //带翻译

        upgradePlan_stratPlan: "Enable",
        upgradePlan_timeDelayTip: "The {1} page will be displayed in {0}.",
        upgradePlan_finishCreate: "{0} has been created",
        upgradePlan_finishModify: "{0} has been modified.",
        upgradePlan_severityS: "Severity",
        upgradePlan_severityStatus: "Critical",
        upgradePlan_normalStatus: "Normal",
        upgradePlan_unkownStatus: "Unknown",

        upgradePlan_SPVersionComponent: "When the SmartProvisioning version is earlier than {0}, the board firmware update is not supported. Download and update the SmartProvisioning first.",
        upgradePlan_BMCVersionComponent: "If the BMC version is earlier than {0}, the SmartProvisioning update is not supported. Download and update the BMC first.",
        upgradePlan_SPCanUpgradeOne: "(1) This operation will update the SmartProvisioning. After the SmartProvisioning is updated, the device automatically resets for the update to takes effect.",
        upgradePlan_SPCanUpgradeTwo: "(2) The update takes 40 minutes, which prolongs the update time of the entire device.",
        upgradePlan_NoSPInfoComponent: "A V3 server does not have the SmartProvisioning component. Therefore, board firmware update is not supported for the V3 server.",
        upgradePlan_confirmSP: "Are you sure you want to update the SmartProvisioning?",
        upgradePlan_needUpgradeSPOne: " (1) The current Smart Provisioning version is earlier than {0}. This operation will forcibly update Smart Provisioning.",
        upgradePlan_needUpgradeSPTwo: "(2) After Smart Provisioning is updated, all firmware versions take effect immediately. Services will be interrupted during the update.",
        upgradePlan_needUpgradeSPThree: "(3) The update of Smart Provisioning takes 40 minutes, which prolongs the update time of the entire device.",
        upgradePlan_noMatchingneedUpgradeSPOne: "(1) After the update, some board drivers and firmware versions are incompatible. Services may be interrupted after the update.",
        upgradePlan_noMatchingneedUpgradeSPTwo: "(2) The current SmartProvisioning version is earlier than {0}. This operation will forcibly update the SmartProvisioning.",
        upgradePlan_noMatchingneedUpgradeSPThree: "(3) After Smart Provisioning is updated, all firmware versions take effect immediately. Services will be interrupted during the update.",
        upgradePlan_noMatchingneedUpgradeSPFour: " (4) The update of Smart Provisioning takes 40 minutes, which prolongs the update time of the entire device.",
        upgradePlan_risk: "Critical",
        upgradePlan_beforeUpgradeVersion: "Source Version",
        upgradePlan_alreadySelect: "Selected Devices",
        upgradePlan_alreadySelectPackage: "Selected Packages",
        upgradePlan_limit: " A maximum of 1000 devices can be updated at a time.",

        /***************2019-07-17***************/
        upgradePlan_addBaseline: "Add Baseline",
        upgradePlan_quickUpgradetips: "now",
    }
